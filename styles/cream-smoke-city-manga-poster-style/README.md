...
![Cream Smoke City Manga Poster Style 代表图](preview-16x9.jpg)
...
打开 `style.json`，或打开 [可复制的 Prompt](../../docs/copy-prompts/cream-smoke-city-manga-poster-style.md)，替换其中的主题和变量后，提交到支持文字生图的平台。需要更稳定时，同时参考本目录的预览图和约束字段。
