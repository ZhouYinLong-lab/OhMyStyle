...
![Electric Blue Silhouette Product Launch Style 代表图](preview-16x9.jpg)
...
1. 下载本目录，打开 `style.json` 或 [复制 Prompt](../../docs/copy-prompts/electric-blue-silhouette-product-launch-style.md)。
