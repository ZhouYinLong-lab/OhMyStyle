...
![Chromatic Fisheye Orbit Pop Poster Style 代表图](preview-16x9.jpg)
...
1. 下载本目录，打开 `style.json` 或 [复制 Prompt](../../docs/copy-prompts/chromatic-fisheye-orbit-pop-poster-style.md)。
