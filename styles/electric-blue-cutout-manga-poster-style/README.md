...
![Electric Blue Cutout Manga Poster Style 代表图](preview-16x9.jpg)
...
1. 下载本目录，打开 `style.json` 或 [复制 Prompt](../../docs/copy-prompts/electric-blue-cutout-manga-poster-style.md)。
