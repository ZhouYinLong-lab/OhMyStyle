...
![Blue Chinese Perspective Type Canyon Style 代表图](preview-16x9.jpg)
...
1. 下载本目录，打开 `style.json` 或 [复制 Prompt](../../docs/copy-prompts/blue-chinese-perspective-type-canyon-style.md)。
