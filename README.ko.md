...
이 6개 스타일로 시작하면 라이브러리의 범위를 빠르게 이해할 수 있습니다. 모든 스타일은 JSON 하나와 미리보기 이미지 두 장으로 구성됩니다. 전체 110개는 아래 [All Styles](#all-styles) 갤러리에서 볼 수 있습니다.
...
<p><a href="styles/cobalt-xerox-script-editorial-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/cobalt-xerox-script-editorial-poster-style.md">프롬프트 복사</a> · <a href="styles/cobalt-xerox-script-editorial-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/coral-window-megatype-motion-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/coral-window-megatype-motion-poster-style.md">프롬프트 복사</a> · <a href="styles/coral-window-megatype-motion-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/cobalt-megatype-roadside-travel-editorial-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/cobalt-megatype-roadside-travel-editorial-style.md">프롬프트 복사</a> · <a href="styles/cobalt-megatype-roadside-travel-editorial-style">폴더</a></p>
</td>
</tr>
</table>
