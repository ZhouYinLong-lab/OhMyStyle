...
<p align="center">
  This is an independently maintained visual-style package project that began
  from the structure and materials of the original AI Visual Prompt Cookbook.
  See <a href="NOTICE">NOTICE</a> for attribution and licensing scope.
</p>
...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 110 in the [All Styles](#all-styles) gallery below.
...
<p><a href="styles/cobalt-xerox-script-editorial-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/cobalt-xerox-script-editorial-poster-style.md">Copy Prompt</a> · <a href="styles/cobalt-xerox-script-editorial-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/coral-window-megatype-motion-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/coral-window-megatype-motion-poster-style.md">Copy Prompt</a> · <a href="styles/coral-window-megatype-motion-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/cobalt-megatype-roadside-travel-editorial-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/cobalt-megatype-roadside-travel-editorial-style.md">Copy Prompt</a> · <a href="styles/cobalt-megatype-roadside-travel-editorial-style">Folder</a></p>
</td>
</tr>
</table>
...
This project began as an independent adaptation of the structural ideas and
public materials found in [VigoZhao/AI-Visual-Prompt-Cookbook](https://github.com/VigoZhao/AI-Visual-Prompt-Cookbook).

It is not a GitHub fork and is maintained as a separate project with a broader
focus on reusable visual-style packages, photography, painting, provenance,
reproducibility, and visual-style interoperability. See [NOTICE](NOTICE) for
the attribution and licensing boundaries that apply to inherited material.
