...
![Bauhaus representative image](gallery-16x9.jpg)

> **Category:** schools
> **Directory:** `style-packages/schools/bauhaus`
...
Emphasizes geometric order, basic forms, primary-color relationships, functional structure, and negative space across graphic, spatial, product, and abstract compositions without copying a specific design.

## Sources

- [包豪斯德绍官方历史介绍](https://www.bauhaus.de/en/das-bauhaus/)
- [MoMA 包豪斯收藏检索](https://www.moma.org/collection/?q=bauhaus)
...
Start with “geometric order, basic forms, primary colour, functional structure, and active negative space”. It sets the viewing rhythm while leaving the subject open to your prompt.
