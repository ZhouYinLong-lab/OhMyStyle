...
![罗德岛设计学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/risd`

## 简介

以材料实践、问题意识、批判思考和跨学科制作共同推动设计学习。

## 可观察特征

material practice, question-led making, critical thinking, cross-disciplinary studio。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
“以材料实践、问题意识、批判思考和跨学科制作共同推动设计学习”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
