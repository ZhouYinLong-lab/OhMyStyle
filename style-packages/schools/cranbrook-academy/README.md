...
![克兰布鲁克艺术学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/cranbrook-academy`

## 简介

以驻校导师、工作室实践和跨学科材料实验为核心的设计教育传统。

## 可观察特征

studio-based practice, artist-in-residence mentorship, craft, material experimentation, cross-disciplinary design。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
它最动人的地方是“以驻校导师、工作室实践和跨学科材料实验为核心的设计教育传统”。画面不依赖固定场景，视觉秩序本身已经很清楚。
