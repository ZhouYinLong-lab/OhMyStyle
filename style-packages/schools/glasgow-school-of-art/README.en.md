...
![Representative image of 格拉斯哥艺术学院](gallery-16x9.jpg)

> **Category:** 设计学院
> **Directory:** `style-packages/schools/glasgow-school-of-art`

## Overview

以建筑线性结构、装饰性自然形态和工艺细节共同组织视觉空间，强调结构与装饰之间的张力。 The package turns medium, composition, lighting, palette, material, and surface decisions into executable rules that can be transferred to new subjects and scenes.

## Observable features

linear architectural structure, stylized botanical forms, craft detail, dark timber.
...
Get “architectural line, ornamental natural forms, craft detail, and tension between structure and decoration” right first; leave the actual content to your prompt. The style can then travel to another subject.
