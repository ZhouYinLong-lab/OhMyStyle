...
![帕森斯设计学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/parsons-school-of-design`

## 简介

以城市语境、设计方法、对象研究和可执行的过程图谱组织视觉方案。

## 可观察特征

urban context, design methodology, object research, process mapping, practical systems。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
这个方向的气质落在“以城市语境、设计方法、对象研究和可执行的过程图谱组织视觉方案”上。保住这条线索，换成新的主体也能成立。
