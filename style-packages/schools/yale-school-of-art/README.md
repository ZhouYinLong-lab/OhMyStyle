...
![耶鲁艺术学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/yale-school-of-art`

## 简介

以研究、批判讨论、媒介专注和高度个人化的工作室实践形成当代学院气质。

## 可观察特征

research and critique, medium-specific practice, personal studio language, architectural clarity。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
我会先看“以研究、批判讨论、媒介专注和高度个人化的工作室实践形成当代学院气质”。它把观看节奏定下来，题材可以按你的需要替换。
