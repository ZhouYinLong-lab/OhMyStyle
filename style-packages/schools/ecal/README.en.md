...
![ECAL representative](gallery-16x9.jpg)

> **Category:** school
> **Domain:** design
> **Path:** `style-packages/schools/ecal`

## Overview

以跨学科、研究驱动和专业制作把摄影、平面、产品与数字媒介放在同一实验场中。
...
The useful quality is not the number of materials, but the way each one has a
position and a purpose. Start by defining the relation being studied, then choose
only the samples that support it; when every element is present only to look good,
the design logic disappears.
