...
![洛桑艺术设计学院代表图](gallery-16x9.jpg)

> **分类：** 艺术与摄影学校
> **媒介领域：** 设计
> **目录：** `style-packages/schools/ecal`
...
我喜欢它把不同材料放在同一张桌面上，却没有让画面变成“素材大集合”：每个东西都有位置，也都有用途。生成时可以先写清楚要研究的关系，再选择少量材料来支撑它；当每个元素都只是为了好看，设计感反而会消失。
