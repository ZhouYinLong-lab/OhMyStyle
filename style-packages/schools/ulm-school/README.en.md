...
![Ulm School representative image](gallery-16x9.jpg)

> **Category:** schools
> **Type:** school
> **Path:** `style-packages/schools/ulm-school`

## Overview

This independent style package for **Ulm School** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

功能主义、系统化网格、信息清晰与中性材料. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Ulm designers / 20世纪50至60年代](https://commons.wikimedia.org/w/index.php?search=Ulm+School+design&title=Special:MediaSearch&type=image)
...
“functionalism, systematic grid, information clarity, and neutral material” sets the viewing distance. People, objects, and places can change independently.
