...
![芝加哥艺术学院 代表图](gallery-16x9.jpg)

> **分类：** 艺术与摄影学校
> **媒介领域：** 混合媒介
> **目录：** `style-packages/schools/school-of-the-art-institute-of-chicago`
...
这个包强调从问题出发，再让媒介和展示方式共同回应问题。它的价值不在于固定一套颜色或构图，而在于把研究、过程和最终画面放进同一条清晰的视觉链路里。
