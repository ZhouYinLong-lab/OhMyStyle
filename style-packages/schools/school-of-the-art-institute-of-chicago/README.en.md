...
![School of the Art Institute of Chicago representative](gallery-16x9.jpg)

> **Category:** school
> **Domain:** hybrid
> **Path:** `style-packages/schools/school-of-the-art-institute-of-chicago`

## Overview

以跨学科研究、过程公开和展览语境中的实验性，连接绘画、物件、影像、空间与批评性编辑。
...
This package begins with a question, then lets medium and presentation answer it together. Its value is not a fixed palette or composition, but a clear visual chain connecting research, process, and the final image.
