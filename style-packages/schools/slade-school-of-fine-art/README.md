...
![斯莱德美术学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/slade-school-of-fine-art`

## 简介

以开放的实验媒介、工作室研究、版画与雕塑实践建立跨学科的艺术教育方法。

## 可观察特征

experimental media, studio research, printmaking, sculpture, interdisciplinary practice。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
先把“以开放的实验媒介、工作室研究、版画与雕塑实践建立跨学科的艺术教育方法”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
