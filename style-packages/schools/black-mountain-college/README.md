...
![黑山学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/black-mountain-college`

## 简介

以实践、协作、实验和跨媒介学习为核心的进步艺术教育传统，强调开放过程而非固定样式。

## 可观察特征

collaborative making, experimental learning, open studio, cross-media practice。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
这个方向的气质落在“以实践、协作、实验和跨媒介学习为核心的进步艺术教育传统，强调开放过程而非固定样式”上。保住这条线索，换成新的主体也能成立。
