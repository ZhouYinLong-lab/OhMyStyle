...
![艺术中心设计学院代表图](gallery-16x9.jpg)

> **分类：** 艺术与摄影学校
> **媒介领域：** 设计
> **目录：** `style-packages/schools/artcenter`

## 简介

以清晰的设计问题、专业化视觉沟通、精确的形式控制和可交付的呈现质量组织图像，不限定具体产品或行业对象。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

它给人的感觉不是“把东西摆得漂亮”，而是让每一个视觉决定都能被解释。主方案、材料、推演和原型各自承担证据角色，版面则负责让它们迅速被读懂。生成时先提出一个清楚的问题，再给答案留出空间，画面会比堆满灵感图更有力量。
