...
![丹麦皇家艺术学院 代表图](gallery-16x9.jpg)

> **分类：** 艺术与摄影学校
> **媒介领域：** 设计
> **目录：** `style-packages/schools/royal-danish-academy`
...
这个方向吸引我的地方，是它把“好看”放在材料、用途和环境之后：结构先说话，质感随后出现，装饰只在需要时介入。它不等于一套固定的北欧家具图鉴；无论主体是产品、空间还是抽象构件，都可以用同样的研究式秩序来处理。
