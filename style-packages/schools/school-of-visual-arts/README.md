...
![视觉艺术学院 代表图](gallery-16x9.jpg)

> **分类：** 艺术与摄影学校
> **媒介领域：** 设计
> **目录：** `style-packages/schools/school-of-visual-arts`
...
这个包更像一套开放的工作方法，而不是固定画风：先把概念说清楚，再让媒介、编辑和展示方式共同决定图像。它适合需要跨越插画、摄影、平面和装置语言的主题，但不会强行加入课堂或学生作品的叙事。
