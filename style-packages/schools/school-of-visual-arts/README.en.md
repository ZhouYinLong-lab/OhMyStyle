...
![School of Visual Arts representative](gallery-16x9.jpg)

> **Category:** school
> **Domain:** design
> **Path:** `style-packages/schools/school-of-visual-arts`

## Overview

以跨媒介实验、清晰的概念框架和面向展示的视觉叙事，组织平面、影像、物件与空间之间的关系。
...
This package is better understood as an open working method than as a fixed look: clarify the concept, then let medium, editing, and presentation shape the image together. It suits subjects that move between illustration, photography, graphic design, and installation without forcing a classroom or student-work narrative.
