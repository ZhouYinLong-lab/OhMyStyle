...
![New Bauhaus representative image](gallery-16x9.jpg)

> **Category:** schools
> **Type:** school
> **Path:** `style-packages/schools/new-bauhaus`

## Overview

This independent style package for **New Bauhaus** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

基础几何、实验构成、材料感与形式功能统一. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Bauhaus designers / 20世纪](https://commons.wikimedia.org/w/index.php?search=New+Bauhaus+design&title=Special:MediaSearch&type=image)
...
“basic geometry, experimental composition, material awareness, and form joined to function” sets the viewing distance. People, objects, and places can change independently.
