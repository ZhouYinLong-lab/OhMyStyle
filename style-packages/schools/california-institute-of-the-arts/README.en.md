...
![California Institute of the Arts representative](gallery-16x9.jpg)

> **Category:** school
> **Domain:** design
> **Path:** `style-packages/schools/california-institute-of-the-arts`

## Overview

以跨媒介、批判思考、实验制作和展览语境之间的往返，形成开放而过程导向的当代艺术提案。
...
This package is not an “art school scene.” It is a working method: clarify the question first, then choose materials and a way to present them. Keep one conceptual anchor and let paper, clay, metal, or projection do different jobs; the image gains strength from editing rather than from filling the frame.
