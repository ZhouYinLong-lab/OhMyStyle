...
![加州艺术学院 代表图](gallery-16x9.jpg)

> **分类：** 艺术与摄影学校
> **媒介领域：** 设计
> **目录：** `style-packages/schools/california-institute-of-the-arts`
...
这个包的重点不在“艺术院校场景”，而在一种先想清楚问题、再选择材料和展示方式的工作方法。生成时可以只保留一个概念锚点，让纸、黏土、金属或投影各自承担不同的任务，画面会比堆满材料更有力量。
