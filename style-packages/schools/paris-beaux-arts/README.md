...
![巴黎美术学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/paris-beaux-arts`

## 简介

以工作室观察、经典比例、材料训练和历史连续性建立学院派的基础方法。

## 可观察特征

atelier observation, classical proportion, material discipline, historical continuity, north light。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
我会先看“以工作室观察、经典比例、材料训练和历史连续性建立学院派的基础方法”。它把观看节奏定下来，题材可以按你的需要替换。
