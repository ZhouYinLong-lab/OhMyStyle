...
![加州艺术学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/california-college-of-the-arts`

## 简介

以湾区开放工作室、艺术与设计协作、建筑模型和可持续材料实验组织视觉学习。

## 可观察特征

open studio, art-design collaboration, architecture models, sustainable material experiments。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
“以湾区开放工作室、艺术与设计协作、建筑模型和可持续材料实验组织视觉学习”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
