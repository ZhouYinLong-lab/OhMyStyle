...
![皇家艺术学院代表图](gallery-16x9.jpg)

> **分类：** 设计学院
> **目录：** `style-packages/schools/royal-college-of-art`

## 简介

以研究驱动、跨学科、材料实验和设计实践共同推动视觉方案，重视从问题到原型的转换过程。

## 可观察特征

research-led design, material prototyping, interdisciplinary practice, inventive order。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
它最动人的地方是“以研究驱动、跨学科、材料实验和设计实践共同推动视觉方案，重视从问题到原型的转换过程”。画面不依赖固定场景，视觉秩序本身已经很清楚。
