...
![Central Saint Martins representative](gallery-16x9.jpg)

> **Category:** school
> **Domain:** design
> **Path:** `style-packages/schools/central-saint-martins`

## Overview

以跨媒介实验、研究驱动的视觉沟通和材料工作坊把设计当作思考与制作共同推进的过程。
...
The useful decision is to let a clear design question organize a messy research table. Materials can vary, but every fragment should answer the same task and the negative space should keep the hierarchy readable.
