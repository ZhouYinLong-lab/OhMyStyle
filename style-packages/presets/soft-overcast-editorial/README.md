...
![柔和阴天编辑摄影代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/soft-overcast-editorial`

## 简介

以均匀阴天光、低对比层次和克制色彩建立安静的编辑摄影预设，适合人物、建筑与日常物件。

## 可观察特征

soft overcast daylight, low contrast, restrained editorial color, gentle diffuse shadows。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
它最动人的地方是“以均匀阴天光、低对比层次和克制色彩建立安静的编辑摄影预设，适合主体、建筑与日常物件”。画面不依赖固定场景，视觉秩序本身已经很清楚。
