...
![森林绿自然主义代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/forest-green-naturalism`

## 简介

以森林绿、自然散射光和可信的有机表面保持场景的自然秩序，适合户外环境与材质观察。

## 可观察特征

forest green, dappled natural daylight, believable organic textures, calm composition。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
“以森林绿、自然散射光和可信的有机表面保持场景的自然秩序，适合户外环境与材质观察”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
