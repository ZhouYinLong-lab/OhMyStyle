# Hard-Light Color Blocking

[中文](README.md)

![Hard-Light Color Blocking representative image](gallery-16x9.jpg)

> **Category:** presets
> **Directory:** `style-packages/presets/hard-light-color-blocking`
...
Organizes images through hard directional light, clear shadows, separated color planes, and material differences without pretending to be the style of a particular photographer or subject.

## Sources

- [MoMA 现代摄影收藏](https://www.moma.org/collection/)
...
The character of this package sits in “hard directional light, clear shadow, separated colour blocks, and visible material differences”. Keep that thread and a new subject can still belong here.
