...
![硬光色块摄影代表图](gallery-16x9.jpg)

> **分类：** 原创预设
> **目录：** `style-packages/presets/hard-light-color-blocking`

## 简介

这是一个面向「硬光色块摄影」的独立风格包。它把公开资料与可观察的媒介、构图、色彩、光线、材质和纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

以硬质方向光、清楚投影、分离的大色块和材质差异组织画面；不把色彩预设误写成某位摄影师或某个题材的风格。
...
这个方向的气质落在“以硬质方向光、清楚投影、分离的大色块和材质差异组织画面；不把色彩预设误写成某位摄影师或某个题材的风格”上。保住这条线索，换成新的主体也能成立。
