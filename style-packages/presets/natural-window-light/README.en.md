...
![Natural Window Light representative image](gallery-16x9.jpg)

> **Category:** presets
> **Type:** preset
> **Path:** `style-packages/presets/natural-window-light`

## Overview

This independent style package for **Natural Window Light** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

大窗软光、自然阴影、低饱和材质与真实镜头表现. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
“large soft window light, natural shadow, low-saturation material, and a credible lens response” sets the viewing distance. People, objects, and places can change independently.
