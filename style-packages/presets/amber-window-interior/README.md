...
![琥珀窗光室内代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/amber-window-interior`

## 简介

以温暖窗光、木材和织物的真实表面建立具有时间感但不复古的室内预设。

## 可观察特征

amber window light, warm wood, linen texture, quiet interior geometry。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
这个方向的气质落在“以温暖窗光、木材和织物的真实表面建立具有时间感但不复古的室内预设”上。保住这条线索，换成新的主体也能成立。
