# Muted Documentary Color

[中文](README.md)

![Muted Documentary Color representative image](gallery-16x9.jpg)

> **Category:** presets
> **Directory:** `style-packages/presets/muted-documentary-color`
...
Builds an observational look through restrained but not lifeless color, natural overcast light, ordinary surfaces, and unforced framing; it is not bound to a subject, place, or narrative.

## Sources

- [MoMA 纪实摄影术语](https://www.moma.org/collection/terms/documentary-photography)
- [OhMyStyle 原创预设实践](https://github.com/ZhouYinLong-lab/OhMyStyle)
...
Get “muted but not dull colour, overcast light, ordinary surfaces, and an unforced viewpoint” right first; leave the actual content to your prompt. The style can then travel to another subject.
