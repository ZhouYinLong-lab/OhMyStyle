...
![低饱和纪实色彩代表图](gallery-16x9.jpg)

> **分类：** 原创预设
> **目录：** `style-packages/presets/muted-documentary-color`

## 简介

这是一个面向「低饱和纪实色彩」的独立风格包。它把公开资料与可观察的媒介、构图、色彩、光线、材质和纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

用低饱和但不灰暗的色彩、自然阴天光、普通表面与不刻意的取景建立观察感；不绑定人物、地点或叙事。
...
先把“用低饱和但不灰暗的色彩、自然阴天光、普通表面与不刻意的取景建立观察感；不绑定主体、地点或叙事”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
