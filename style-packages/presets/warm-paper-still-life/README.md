...
![暖纸色静物代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/warm-paper-still-life`

## 简介

以暖象牙色纸面、手工边缘、天然物件和柔和侧光建立触感明确的静物预设。

## 可观察特征

warm ivory paper, handmade edges, natural objects, tactile side light。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
先把“以暖象牙色纸面、手工边缘、天然物件和柔和侧光建立触感明确的静物预设”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
