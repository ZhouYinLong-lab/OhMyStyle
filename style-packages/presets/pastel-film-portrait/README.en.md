# Pastel Film Portrait

[中文](README.md)

![Pastel Film Portrait representative image](gallery-16x9.jpg)

> **Category:** presets
> **Type:** preset
> **Path:** `style-packages/presets/pastel-film-portrait`

## Overview

This independent style package for **Pastel Film Portrait** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

自然窗光、粉彩服饰、柔和肤色与细腻胶片颗粒. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
The character of this package sits in “natural window light, pastel clothing, soft skin tones, and fine film grain”. Keep that thread and a new subject can still belong here.
