...
![安静直闪纪实代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/quiet-flash-documentary`

## 简介

以克制的机顶直闪、真实投影和不修饰的环境细节建立低戏剧性的纪实预设。

## 可观察特征

quiet on-camera flash, honest hard shadows, ordinary environment, documentary restraint。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
“以克制的机顶直闪、真实投影和不修饰的环境细节建立低戏剧性的纪实预设”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
