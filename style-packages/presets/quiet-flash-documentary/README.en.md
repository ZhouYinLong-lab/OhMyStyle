...
![Representative image of 安静直闪纪实](gallery-16x9.jpg)

> **Category:** 摄影
> **Directory:** `style-packages/presets/quiet-flash-documentary`

## Overview

以克制的机顶直闪、真实投影和不修饰的环境细节建立低戏剧性的纪实预设。 The package turns medium, composition, lighting, palette, material, and surface decisions into executable rules that can be transferred to new subjects and scenes.

## Observable features

quiet on-camera flash, honest hard shadows, ordinary environment, documentary restraint.
...
“restrained on-camera flash, real cast shadow, and unpolished environmental detail” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
