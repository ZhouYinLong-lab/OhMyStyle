...
![灰粉影棚静物代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/dusty-rose-studio`

## 简介

以灰粉背景、纸张形体和哑光材质建立柔和而现代的静物影棚预设。

## 可观察特征

dusty rose seamless background, paper forms, matte materials, soft frontal light。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
先把“以灰粉背景、纸张形体和哑光材质建立柔和而现代的静物影棚预设”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
