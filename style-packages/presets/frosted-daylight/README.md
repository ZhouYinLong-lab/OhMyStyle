...
![磨砂日光代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/frosted-daylight`

## 简介

以冷白日光、半透明材质和低对比边缘建立轻盈、安静的日光预设。

## 可观察特征

cool diffused daylight, translucent materials, low-contrast edges, airy still life。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
我会先看“以冷白日光、半透明材质和低对比边缘建立轻盈、安静的日光预设”。它把观看节奏定下来，题材可以按你的需要替换。
