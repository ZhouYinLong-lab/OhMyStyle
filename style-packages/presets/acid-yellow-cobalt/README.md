...
![酸黄钴蓝代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/acid-yellow-cobalt`

## 简介

以受控的高纯度酸黄与钴蓝关系建立清晰、现代且不依赖霓虹效果的产品视觉预设。

## 可观察特征

controlled acid yellow and cobalt blue, crisp product composition, neutral surroundings。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
我会先看“以受控的高纯度酸黄与钴蓝关系建立清晰、现代且不依赖霓虹效果的产品视觉预设”。它把观看节奏定下来，题材可以按你的需要替换。
