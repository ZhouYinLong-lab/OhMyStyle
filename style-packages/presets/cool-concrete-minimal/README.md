...
![冷灰混凝土极简代表图](gallery-16x9.jpg)

> **分类：** 摄影
> **目录：** `style-packages/presets/cool-concrete-minimal`

## 简介

以冷灰建筑表面、几何留白和单一强调色建立清晰的极简空间预设。

## 可观察特征

cool concrete, precise geometry, sparse negative space, one controlled accent color。本包把媒介、构图、光线、色彩、材质和表面处理写成可执行规则，支持把同一组规则迁移到新的主题、物体和场景。
...
“以冷灰建筑表面、几何留白和单一强调色建立清晰的极简空间预设”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
