# Monochrome Silver Gelatin

[中文](README.md)

![Monochrome Silver Gelatin representative image](gallery-16x9.jpg)

> **Category:** presets
> **Type:** preset
> **Path:** `style-packages/presets/monochrome-silver-gelatin`

## Overview

This independent style package for **Monochrome Silver Gelatin** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

银盐灰阶、暗房反差、湿地细节与中性纪实. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
Its strongest pull comes from “silver-gelatin grey, darkroom contrast, wet surfaces, and neutral documentary presence”. The visual order remains clear without a fixed scene.
