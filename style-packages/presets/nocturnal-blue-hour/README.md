...
![夜色蓝调代表图](gallery-16x9.jpg)

> **分类：** 原创预设
> **类型：** 原创预设
> **目录：** `style-packages/presets/nocturnal-blue-hour`

## 简介

这是一个面向「夜色蓝调」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

蓝调时刻、湿地反光、低照度细节与克制人工光。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
我会先看“蓝调时刻、湿地反光、低照度细节与克制人工光”。它把观看节奏定下来，题材可以按你的需要替换。
