...
![Nocturnal Blue Hour representative image](gallery-16x9.jpg)

> **Category:** presets
> **Type:** preset
> **Path:** `style-packages/presets/nocturnal-blue-hour`

## Overview

This independent style package for **Nocturnal Blue Hour** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

蓝调时刻、湿地反光、低照度细节与克制人工光. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
Start with “blue-hour colour, wet reflections, low-light detail, and restrained practical light”. It sets the viewing rhythm while leaving the subject open to your prompt.
