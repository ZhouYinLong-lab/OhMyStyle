...
![Gerhard Richter representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/gerhard-richter`

## Overview

以照片绘画的柔焦、刮板拖拽和抽象色层在具象与非具象之间制造不确定的观看。
...
The useful decision is to let the subject stand first, then interrupt it with scraping and translucent layers. If everything becomes abstract from the start, the most distinctive tension is lost.
