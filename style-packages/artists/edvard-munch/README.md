...
这是一个面向「爱德华·蒙克」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

compress or tilt space so the environment participates in the emotion；use a small or isolated figure against a让这个方向有了自己的呼吸。换一个主体后，比例、边缘和光线仍应保留这份感觉。
