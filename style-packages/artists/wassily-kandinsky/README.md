...
![瓦西里·康定斯基 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **类型：** 艺术家
> **目录：** `style-packages/artists/wassily-kandinsky`

## 简介

这是一个面向「瓦西里·康定斯基」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

先把“以几何形、抒情线条、相互牵制的色彩、层叠平面和整体构图平衡构成抽象画面，不把抽象语言强行解释成叙事插图”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
