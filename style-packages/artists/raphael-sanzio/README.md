...
![拉斐尔代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **类型：** 艺术家
> **目录：** `style-packages/artists/raphael-sanzio`

## 简介

这是一个面向「拉斐尔」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

“## 风格重点 理想化人体、平衡群像、清晰轮廓与古典秩序”决定了这个包的观看距离。人物、物体和环境都可以另行指定。

## 风格重点

理想化人体、平衡群像、清晰轮廓与古典秩序。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。

完整规则见 `visual-signature.yaml`、`reproduction.yaml`、`palette/palette.json` 和 `evaluation.yaml`。

## 参考来源

- [Raphael / 文艺复兴盛期](https://commons.wikimedia.org/w/index.php?search=Raphael+paintings&title=Special:MediaSearch&type=image)
