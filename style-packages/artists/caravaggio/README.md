...
![卡拉瓦乔代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **类型：** 艺术家
> **目录：** `style-packages/artists/caravaggio`

## 简介

这是一个面向「卡拉瓦乔」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

它最动人的地方是“## 风格重点 明暗对照、单一光源、普通主体与戏剧性空间”。画面不依赖固定场景，视觉秩序本身已经很清楚。

## 风格重点

明暗对照、单一光源、普通人物与戏剧性空间。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。

完整规则见 `visual-signature.yaml`、`reproduction.yaml`、`palette/palette.json` 和 `evaluation.yaml`。

## 参考来源

- [Caravaggio / 巴洛克早期](https://commons.wikimedia.org/w/index.php?search=Caravaggio+paintings&title=Special:MediaSearch&type=image)
