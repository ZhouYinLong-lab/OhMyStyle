...
![卡济米尔·马列维奇 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **媒介领域：** 绘画
> **目录：** `style-packages/artists/kazimir-malevich`
...
马列维奇式的力量来自删减：当物体不再承担叙事，比例、方向、间隔和色块之间的关系就成为画面的内容。本包适合把主题转译成一个清晰的平面秩序，而不是反复生成某个标志性几何图形。
