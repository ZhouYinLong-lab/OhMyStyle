...
![埃尔·利西茨基代表图](gallery-16x9.jpg)

> **分类：** 艺术家  · **媒介领域：** 绘画与设计
> **目录：** style-packages/artists/el-lissitzky

## 简介

以几何构造、空间投影、斜向动力和工程化版式建立视觉秩序，适合抽象图形、建筑表面与信息结构。

## 一点观察

莫斯科与柏林先锋派语境中的几何构成、空间投影和工程化视觉思维。我更愿意把它看成一组可迁移的视觉决定：几何块面与斜向向量建立视觉力场，再由光线、表面和空间共同完成画面。这个包提取可观察特征，不把某个作品的题材、构图或故事一起带入。
...
- [El Lissitzky](https://www.moma.org/artists/3569-el-lissitzky)
