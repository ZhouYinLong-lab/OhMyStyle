...
![约瑟夫·马洛德·威廉·透纳 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **类型：** 艺术家
> **目录：** `style-packages/artists/jmw-turner`

## 简介

这是一个面向「约瑟夫·马洛德·威廉·透纳」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

先把“以边缘溶解、层层叠加的雾化颜料、发光天气和有方向的空间运动表现空气与光，不复刻具体海景或道路或线性结构构图”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
