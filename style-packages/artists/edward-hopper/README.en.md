...
![Edward Hopper representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/edward-hopper`

## Overview

Modern American scene painting built from simplified architecture, isolated figures, strong window light, and restrained color with psychological distance.
