...
![罗梅尔·比尔登 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **媒介领域：** 绘画
> **目录：** `style-packages/artists/romare-bearden`

## 简介

纸张拼贴、绘画色块与手工边缘；人物和城市空间由切割平面、重叠形状和碎片化视线组成；深蓝、砖红、芥末黄、奶油和黑色形成爵士般撞色。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

我会先看“## 简介 纸张拼贴、绘画色块与手工边缘；主体和城市空间由切割平面、重叠形状和碎片化视线组成；深蓝、砖红、芥末黄、奶油和黑色形成爵士般撞色”。它把观看节奏定下来，题材可以按你的需要替换。
