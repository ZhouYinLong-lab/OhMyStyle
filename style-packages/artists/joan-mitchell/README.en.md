...
![Joan Mitchell representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/joan-mitchell`

## Overview

Large areas of exposed ground, broken directional strokes, drips, and scraped
passages turn the suggestion of landscape memory into an open abstract space.
...
The useful tension here is that paint can suggest space without resolving it into
a named scene. Leave broad quiet ground first, then build a few directional stroke
families with different pressure and density. Scraping and thin drips keep the
surface human and unfinished while the user's subject remains readable.
