...
![Yayoi Kusama representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/yayoi-kusama`

## Overview

以重复、增殖、网状覆盖、软雕塑和镜面空间制造近乎无限的观看经验，并让单一视觉单位不断扩张。
...
The useful tension here comes from a small visual unit expanding until object, wall,
and floor begin to share one surface logic. Start with a readable subject, then let
repetition accumulate gradually; covering everything at once usually weakens the
spatial rhythm.
