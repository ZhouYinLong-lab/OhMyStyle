...
![草间弥生代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **媒介领域：** 绘画
> **目录：** `style-packages/artists/yayoi-kusama`
...
我喜欢它把一个很小的视觉单位慢慢推向整个空间：先是表面上的重复，随后墙、地面和物体之间的边界也变得不再稳定。生成时不要急着堆满图案，先保留一个主体锚点，再让重复逐步扩张，画面会更有观看的张力。
