...
![Sonia Delaunay representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/sonia-delaunay`

## Overview

This package organizes the image through simultaneous contrast, curved rhythm, and color movement across painting, design, and textile logic.
...
I like how this package gives movement to relationships between colors instead of relying on blur or exaggerated perspective. Break the subject into a few breathable shapes, then let arcs, bands, and neighboring hues push against one another; the image gains rhythm without being tied to one object.
