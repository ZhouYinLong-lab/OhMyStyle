...
![索尼娅·德洛内 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **媒介领域：** 绘画
> **目录：** `style-packages/artists/sonia-delaunay`

## 简介

以同时性对比、圆弧节奏和色彩运动组织画面，让绘画、设计与织物之间形成连续的视觉韵律。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

我喜欢这个包把“运动”交给色彩之间的碰撞，而不是靠模糊或夸张透视。先把主体拆成几块可以呼吸的形状，再让弧线、色带和相邻色彼此推动，画面会有节奏，却不会被某个固定物件绑住。
