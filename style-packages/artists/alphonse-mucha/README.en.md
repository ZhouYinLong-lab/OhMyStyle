...
![Alphonse Mucha representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** design
> **Path:** `style-packages/artists/alphonse-mucha`

## Overview

以流动曲线、植物纹样、人物与边框的连续节奏、温暖纸色和装饰性平面组织画面；本包提取穆夏式视觉语法，不固定女性肖像、花卉、广告或文字。
...
The appeal of a Mucha study is not simply “flowers and long hair.” Line, frame, figure silhouette, and botanical pattern interlock like one melody with variations. The representative image places that continuous decorative rhythm around an ordinary vessel and figure, making the transferable rule clear: keep the compositional syntax, not a fixed subject.
