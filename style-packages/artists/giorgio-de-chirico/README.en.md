...
![Giorgio de Chirico representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/giorgio-de-chirico`

## Overview

Metaphysical painting built from empty piazzas, long shadows, classical architecture, statues, and displaced objects that create suspended enigma.
