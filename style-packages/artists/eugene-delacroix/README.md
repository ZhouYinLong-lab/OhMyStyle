...
![欧仁·德拉克罗瓦代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **类型：** 艺术家
> **目录：** `style-packages/artists/eugene-delacroix`

## 简介

这是一个面向「欧仁·德拉克罗瓦」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

“对角线运动、暖冷冲突、饱和色与自由笔触”决定了这个包的观看距离。人物、物体和环境都可以另行指定。

## 风格重点

对角线运动、暖冷冲突、饱和色与自由笔触。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。

完整规则见 `visual-signature.yaml`、`reproduction.yaml`、`palette/palette.json` 和 `evaluation.yaml`。

## 参考来源

- [Eugène Delacroix / 浪漫主义](https://commons.wikimedia.org/w/index.php?search=Eug%C3%A8ne+Delacroix&title=Special:MediaSearch&type=image)
