...
![Mary Cassatt representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/mary-cassatt`

## Overview

A reference-backed package for Mary Cassatt, built around intimate domestic observation, cropped framing, and soft pastel light.
...
Its strongest pull comes from “intimate cropping, natural gestures, soft pastel edges, and the close scale of everyday attention”. The visual order remains clear without a fixed scene.
