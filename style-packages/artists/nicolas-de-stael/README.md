...
![尼古拉·德·斯塔埃尔 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **媒介领域：** 绘画
> **目录：** `style-packages/artists/nicolas-de-stael`

## 简介

以厚重而清晰的色块、被压缩的空间和介于具象与抽象之间的形体，建立具有重量感的开放绘画语言。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

我喜欢这个包把“厚重”放在颜色和边缘关系里，而不是堆叠表面噪声。生成时可以先把主体压缩成几块有重量的色面，再决定哪些细节值得留下；这样换成椅子、建筑或衣物，画面仍然有自己的秩序。
