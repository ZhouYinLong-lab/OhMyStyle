...
![老彼得·勃鲁盖尔代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **类型：** 艺术家
> **目录：** `style-packages/artists/pieter-bruegel-the-elder`

## 简介

这是一个面向「老彼得·勃鲁盖尔」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

先把“高视点全景、微小群像、季节劳动与乡土地景”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。

## 风格重点

高视点全景、微小群像、季节劳动与乡土地景。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。

完整规则见 `visual-signature.yaml`、`reproduction.yaml`、`palette/palette.json` 和 `evaluation.yaml`。

## 参考来源

- [Pieter Bruegel the Elder / 北方文艺复兴](https://commons.wikimedia.org/w/index.php?search=Pieter+Bruegel+the+Elder&title=Special:MediaSearch&type=image)
