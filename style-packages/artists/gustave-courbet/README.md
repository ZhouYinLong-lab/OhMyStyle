...
![古斯塔夫·库尔贝代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **类型：** 艺术家
> **目录：** `style-packages/artists/gustave-courbet`

## 简介

这是一个面向「古斯塔夫·库尔贝」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 策展短评

我喜欢这个方向里new subject and arrangement；clear primary focal hierarchy留下的安静秩序。画面有清楚的着力点，换成新的主体也能继续成立。

## 风格重点

厚重物质感、未理想化人物、土色现实与坚实地面。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
