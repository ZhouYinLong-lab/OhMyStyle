...
![Yves Klein representative image](gallery-16x9.jpg)
...
This package translates observable visual decisions associated with Yves Klein into reusable generation rules. It is designed for new subjects, not for copying a specific source work.

## Curatorial note

This visual language makes me think of一块被从现实中抽离出来的蓝色空间：它不急着讲故事，却会让表面、距离和身体的尺度变得格外清楚。生成时最值得保留的不是“全画面变蓝”，而是让颜色成为一种有重量的材料。
