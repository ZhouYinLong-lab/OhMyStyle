...
![Katsushika Hokusai representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/katsushika-hokusai`

## Overview

This package studies Hokusai's transferable print logic: carved contour rhythm, layered flat color, selective perspective compression, asymmetrical cropping, and a warm paper surface. It does not make waves, boats, Mount Fuji, or a famous composition mandatory.
...
The representative image uses a maritime subject because it makes the wave rhythm and limited color layers easy to inspect. The package should remain recognizable when the user changes the subject to architecture, objects, or figures.
