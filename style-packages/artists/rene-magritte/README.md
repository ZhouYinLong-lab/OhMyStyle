...
![勒内·马格利特 代表图](gallery-16x9.jpg)

> **分类：** artist
> **媒介领域：** painting
> **目录：** style-packages/artists/rene-magritte

## 简介

以冷静写实的日常物件、尺度错置、图像悖论与清晰轮廓制造陌生感。

这是一个可独立使用的风格包。它提取可观察的视觉语言，用来处理用户指定的新主题，不会把代表图中的物体、地点、人物或故事写入默认生成结果。

## 策展短评

我喜欢它把荒诞藏在很平静的表面下面：物件画得越清楚，关系里的不可能就越有力量。使用这个包时，先让人相信，再让人发现哪里不对。
