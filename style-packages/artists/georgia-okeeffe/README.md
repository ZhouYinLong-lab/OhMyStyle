...
![乔治亚·欧姬芙 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **媒介领域：** 绘画
> **目录：** `style-packages/artists/georgia-okeeffe`

## 简介

平滑渐变、放大花卉或骨骼形体与简洁背景；单一自然形体被放大到接近抽象，边缘清洁且画面留白充足；骨白、沙色、深红、灰蓝和干燥黑形成沙漠般色组。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

“## 简介 平滑渐变、放大花卉或骨骼形体与简洁背景；单一自然形体被放大到接近抽象，边缘清洁且画面留白充足；骨白、沙色、深红、灰蓝和干燥黑形成沙漠般色组”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
