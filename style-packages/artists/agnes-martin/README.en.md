...
![Agnes Martin representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/agnes-martin`

## Overview

Minimal painting built from delicate grids, repeated lines, low-contrast bands, and quiet space, where tiny hand-drawn deviations remain visible.
