...
![马克·夏加尔 代表图](gallery-16x9.jpg)

> **分类：** 艺术家
> **媒介领域：** 绘画
> **目录：** `style-packages/artists/marc-chagall`
...
我喜欢它把空间写成一段会漂浮的记忆：人物、物件和远景不必服从同一套尺度，却能靠色块和节奏彼此照应。使用这个包时，最值得保留的是“关系感”，而不是某个固定形象；让你的主体进入一片有诗意的色彩空间即可。
