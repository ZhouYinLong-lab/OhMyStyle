...
![Marc Chagall representative](gallery-16x9.jpg)

> **Category:** artist
> **Domain:** painting
> **Path:** `style-packages/artists/marc-chagall`

## Overview

以漂浮的人物关系、梦境般的空间错置和强烈但不均匀的色彩叙事，建立带有民间诗意的开放画面。
...
I like the way this package treats space as a floating memory: figures, objects, and distance need not share one scale, yet color blocks and rhythm keep them related. The useful transfer is that sense of relationship, not a fixed motif. Let the user's subject enter a poetic color space and keep the visual decisions open.
