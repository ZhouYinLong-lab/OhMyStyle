...
![森山大道代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **类型：** 摄影师
> **目录：** `style-packages/photographers/daido-moriyama`

## 简介

这是一个面向「森山大道」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

高反差街景、粗颗粒、倾斜取景与都市碎片。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
先把“高反差街景、粗颗粒、倾斜取景与都市碎片”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
