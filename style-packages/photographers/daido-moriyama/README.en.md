...
![Daido Moriyama representative image](gallery-16x9.jpg)

> **Category:** photographers
> **Type:** photographer
> **Path:** `style-packages/photographers/daido-moriyama`

## Overview

This independent style package for **Daido Moriyama** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

高反差街景、粗颗粒、倾斜取景与都市碎片. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Daido Moriyama / 日本战后摄影](https://commons.wikimedia.org/w/index.php?search=Daido+Moriyama&title=Special:MediaSearch&type=image)
...
Get “high-contrast fragments, coarse grain, tilted framing, and the restless pulse of the street” right first; leave the actual content to your prompt. The style can then travel to another subject.
