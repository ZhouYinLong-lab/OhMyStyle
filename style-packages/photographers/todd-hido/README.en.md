...
![Todd Hido representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/todd-hido`

## Overview

以蓝调时刻、住宅边缘和窗内暖光把日常郊区拍成含蓄而悬置的记忆。
...
The feeling comes from the weight of an uneventful place: a road, a building,
and one or two practical lights carry a quiet sense of waiting. Pull the camera
back first, then let a small amount of real warmth hold the eye; too much warmth
turns the scene into advertising.
