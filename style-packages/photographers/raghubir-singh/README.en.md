...
![Raghubir Singh representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/raghubir-singh`

## Overview

Layered color street observation lets people, architecture, reflections, and
ordinary surface colors form a complex but legible spatial rhythm.
...
The image works without an exotic symbol. Color, reflection, and ordinary action
share the same path of looking. Find a partially occluding foreground, wait for a
natural middle-ground action, and let walls, clothing, vehicles, and wet ground
share the visual weight. Saturation should come from the scene, not a global filter.
