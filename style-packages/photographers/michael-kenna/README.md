...
![迈克尔·肯纳 代表图](gallery-16x9.jpg)

> **分类：** 摄影师  · **媒介领域：** 摄影
> **目录：** style-packages/photographers/michael-kenna

## 简介

以极简取景、黑白银盐质感、长曝光和克制的暗部层次观察普通景物。画面保留空旷、时间感与负空间，同时避免把某个地标变成固定主体。

## 一点观察

迈克尔·肯纳的照片常常把世界压缩成少数几条线：一段岸线、一棵树、一道栅栏或一个远处的黑色小点。安静不是空洞，而是长曝光把短暂天气拉成了持续的呼吸。这个包适合让普通场景变得清醒、简洁、有时间感。

## 视觉签名

- 大面积负空间
- 银灰、煤黑与雾白构成连续阶调
- quiet dawn, dusk, overcast, or nocturnal light with long-exposure calm
- fine silver-gelatin grain, restrained contrast, smooth tonal transitions, and soft atmospheric edges
...
- [迈克尔·肯纳官方网站：作品与访谈](https://www.michaelkenna.com/ivform.php)
