...
![曼·雷 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/man-ray`

## 简介

摄影结合太阳化、叠印和暗房实验；静物、人物和几何物件被安排成带有实验感的摄影构图；黑白银盐、奶油灰与少量高纯度色块形成超现实色组。
...
我会先看“摄影结合太阳化、叠印和暗房实验；静物、主体和几何物件被安排成带有实验感的摄影构图；黑白银盐、奶油灰与少量高纯度色块形成超现实色组”。它把观看节奏定下来，题材可以按你的需要替换。
