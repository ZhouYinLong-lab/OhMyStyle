...
![彼得·林德伯格 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/peter-lindbergh`

## 简介

自然主义时尚肖像、少量造型和真实皮肤；人物靠自然姿态和面部结构成立，背景尽量简化；黑白银灰、肤色灰阶、深黑和纸白形成干净时尚色组。
...
“自然主义时尚肖像、少量造型和真实皮肤；主体靠自然姿态和面部结构成立，背景尽量简化；黑白银灰、肤色灰阶、深黑和纸白形成干净时尚色组”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
