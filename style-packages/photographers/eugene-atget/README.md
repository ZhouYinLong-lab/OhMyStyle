...
![欧仁·阿杰 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **类型：** 摄影师
> **目录：** `style-packages/photographers/eugene-atget`

## 简介

这是一个面向「欧仁·阿杰」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
先把“以正面观察、安静的建筑几何、克制的单色影调和大画幅公共空间记录的证据感描写城市，让空旷与细节共同保留现场性”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
