...
![戈登·帕克斯 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/gordon-parks`

## 简介

人文纪实摄影与环境肖像；人物处于真实环境中，环境线索与面部表情同等重要；黑白或低饱和彩色，肤色、深棕、灰蓝和暖黄形成克制对比。
...
我会先看“人文纪实摄影与环境肖像；主体处于真实环境中，环境线索与面部表情同等重要；黑白或低饱和彩色，肤色、深棕、灰蓝和暖黄形成克制对比”。它把观看节奏定下来，题材可以按你的需要替换。
