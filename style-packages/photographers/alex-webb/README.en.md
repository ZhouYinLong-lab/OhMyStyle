...
![Alex Webb representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/alex-webb`

## Overview

以多层次街头观察、鲜明色彩、复杂遮挡和偶然瞬间组织具有空间张力的彩色纪实摄影；本包提取观看方式，不固定热带街道或特定城市。
...
The force of this kind of photograph does not come from vivid color alone. It comes from color, gesture, and spatial occlusion happening at the same time: a wall may cut off the foreground, a passerby may enter a patch of light, and distant architecture may pull the eye back into the street. The image does not resolve itself into a single message. When using this package, keep the patience for layered observation rather than borrowing a particular country or street scene.
