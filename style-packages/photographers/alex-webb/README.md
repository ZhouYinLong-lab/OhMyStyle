...
![亚历克斯·韦布 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/alex-webb`
...
这类照片的力量不只来自鲜艳颜色，而来自颜色、人物动作和空间遮挡同时发生。画面前景可能只留下半面墙，中间人物刚好穿过光线，远处的建筑又把视线带回街道。观看并不被安排成一个明确结论，细节之间的关系反而让普通场景变得紧张而有生命力。使用这个包时，最值得保留的是“多层次地等待一个瞬间”，而不是套用某个国家或街景。
