...
![乔尔·迈耶罗维茨 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/joel-meyerowitz`
...
迈耶罗维茨的彩色摄影常把注意力放在“同时发生”的关系上：光线、人物、建筑和色块各自成立，又在同一视野里互相回应。使用本包时，保留偶然性比安排一个醒目的主角更重要。
