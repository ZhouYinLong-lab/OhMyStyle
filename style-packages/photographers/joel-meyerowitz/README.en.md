...
![Joel Meyerowitz representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/joel-meyerowitz`

## Overview

以彩色街景中的开放空间、并置色块和偶然关系，保留观看距离与日常光线的复杂层次。
...
Meyerowitz's color work often attends to relationships that happen at the same time: light, people, buildings, and color fields remain distinct while answering one another within a single view. The package works best when it preserves contingency instead of inventing a heroic subject.
