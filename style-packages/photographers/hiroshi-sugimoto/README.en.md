...
![Hiroshi Sugimoto representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/hiroshi-sugimoto`

## Overview

Sugimoto's work often reduces photography to exposure, time, and viewing itself: minimal information, restrained gray scale, stable axes, and nearly non-narrative space create a quiet weight. This package extracts those transferable decisions; the sea, horizon, theater, and architecture are not defaults.

## Curatorial note

The representative image uses an empty sea to test horizon placement, gray-scale control, and long-exposure stillness. When the subject changes to architecture, objects, or figures, the same measured restraint should remain instead of becoming a generic black-and-white filter.
