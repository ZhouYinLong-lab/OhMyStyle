...
> **Domain:** photography
> **Path:** `style-packages/photographers/rinko-kawauchi`

## Overview

Poetic photography built from soft natural light, intimate everyday details, airy color, and an open sense of time between small connected observations.
...
Start with “soft natural light, close everyday detail, light colour, uncertain time, and air between small things”. It sets the viewing rhythm while leaving the subject open to your prompt.
