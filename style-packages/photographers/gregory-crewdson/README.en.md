...
![Gregory Crewdson representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/gregory-crewdson`

## Overview

A reference-backed package for Gregory Crewdson, built around staged cinematic stillness, suburban unease, and controlled practical light.
...
The character of this package sits in “carefully staged light, deep focus, suburban stillness, and a cinematic pause with no easy explanation”. Keep that thread and a new subject can still belong here.
