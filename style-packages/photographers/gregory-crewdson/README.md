...
![格里高利·克鲁德森 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/gregory-crewdson`

## 简介

大型制作式摄影、舞台调度与超细致景深；郊区住宅、空街和一个停顿的人物组成高度控制的电影化静止；钨黄、暮蓝、湿黑、草绿和砖红形成冷暖夜景。
...
这个方向的气质落在“大型制作式摄影、舞台调度与超细致景深；郊区住宅、空街和一个停顿的主体组成高度控制的电影化静止；钨黄、暮蓝、湿黑、草绿和砖红形成冷暖夜景”上。保住这条线索，换成新的主体也能成立。
