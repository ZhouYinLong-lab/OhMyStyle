...
![阿尔弗雷德·斯蒂格利茨 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **类型：** 摄影师
> **目录：** `style-packages/photographers/alfred-stieglitz`

## 简介

这是一个面向「阿尔弗雷德·斯蒂格利茨」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
我会先看“以经过设计的形式结构、层层推进的平面、带有天气感的影调和作者意识组织现代主义摄影；照片不是中性的记录，也不是简单的棕褐色预设”。它把观看节奏定下来，题材可以按你的需要替换。
