...
![威廉·克莱因 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/william-klein`

## 简介

广角街头摄影、运动模糊和图形裁切；近距离广角、切边人物和运动中的街道形成冲撞式构图；高反差黑白、红黄蓝广告色和粗颗粒形成城市能量。
...
“广角公共空间摄影、运动模糊和图形裁切；近距离广角、切边主体和运动中的街道形成冲撞式构图；高反差黑白、红黄蓝广告色和粗颗粒形成城市能量”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
