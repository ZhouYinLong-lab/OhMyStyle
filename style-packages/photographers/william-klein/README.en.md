...
![William Klein representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/william-klein`

## Overview

A reference-backed package for William Klein, built around wide-angle street collision, graphic crop, and kinetic grain.
...
“wide-angle proximity, motion blur, hard cropping, coarse grain, and the collision of street energy” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
