...
![尼克·布兰特 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/nick-brandt`

## 简介

平面化环境肖像和低饱和数码摄影；人或动物与巨大空旷环境形成静态纪念碑式关系；灰褐、沙色、雾蓝与低饱和肤色形成压低色组。
...
先把“平面化环境肖像和低饱和数码摄影；人或动物与巨大空旷环境形成静态纪念碑式关系；灰褐、沙色、雾蓝与低饱和肤色形成压低色组”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
