...
![辛迪·舍曼 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/cindy-sherman`

## 简介

构造性肖像摄影、角色化造型与可见布景；单一人物通过服装、姿态和背景暗示身份，但不提供明确叙事；粉灰、旧绿、奶油、黑和人工暖色形成舞台化色组。
...
它最动人的地方是“构造性肖像摄影、角色化造型与可见布景；单一主体通过服装、姿态和背景暗示身份，但不提供明确叙事；粉灰、旧绿、奶油、黑和人工暖色形成舞台化色组”。画面不依赖固定场景，视觉秩序本身已经很清楚。
