...
![Cindy Sherman representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/cindy-sherman`

## Overview

A reference-backed package for Cindy Sherman, built around constructed portrait, theatrical identity, and visible artifice.
...
Its strongest pull comes from “constructed identity, visible staging, costume, and a portrait that leaves its story unresolved”. The visual order remains clear without a fixed scene.
