...
![Diane Arbus representative image](gallery-16x9.jpg)

> **Category:** photographers
> **Type:** photographer
> **Path:** `style-packages/photographers/diane-arbus`

## Overview

This independent style package for **Diane Arbus** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

正面肖像、尴尬静止、普通人的异常感与中画幅灰阶. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Diane Arbus / 20世纪肖像摄影](https://commons.wikimedia.org/w/index.php?search=Diane+Arbus&title=Special:MediaSearch&type=image)
...
“frontal distance, awkward stillness, ordinary difference, and a dry medium-format grey scale” sets the viewing distance. People, objects, and places can change independently.
