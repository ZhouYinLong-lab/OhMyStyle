...
![Sebastião Salgado representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/sebastiao-salgado`

## Overview

A reference-backed package for Sebastião Salgado, built around monumental black-and-white documentary, labor, and broad tonal range.
...
Get “large-scale black-and-white documentary, bodies and terrain, collective labour, and deep layered shadow” right first; leave the actual content to your prompt. The style can then travel to another subject.
