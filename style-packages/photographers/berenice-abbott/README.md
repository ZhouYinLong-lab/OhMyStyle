...
![贝伦妮丝·阿博特 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/berenice-abbott`

## 简介

直接摄影、清晰焦点和精确建筑构图；建筑立面、街道和科学物件以清楚几何结构和垂直线组织；银盐黑白、冷灰、白色和少量金属反光形成技术感色组。
...
“直接摄影、清晰焦点和精确建筑构图；结构、边界和普通物件以清楚几何结构和垂直线组织；银盐黑白、冷灰、白色和少量金属反光形成技术感色组”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
