...
![Miyako Ishiuchi representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/miyako-ishiuchi`

## Overview

This package studies time through close observation of wear, fading, folds, and handled surfaces rather than through a fixed person or place.
...
I like how restrained this package is about the feeling of age. It does not rush to add a nostalgic filter; fading, creases, abrasion, and handled surfaces carry the memory themselves. Replace the sample objects and the sense of time should still remain in the material.
