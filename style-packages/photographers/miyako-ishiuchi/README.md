...
![石内都 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/miyako-ishiuchi`

## 简介

以近距离观看磨损、伤痕、织物和旧物表面，让时间在材料痕迹中显现，而不是依赖固定人物或地点。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

我喜欢这个包对“旧”的处理很克制：它不急着给画面加怀旧滤镜，而是让褪色、折痕、磨损和被触摸过的表面自己说话。换掉示例里的物件，仍然应该能感到时间留在材料上。
