...
> **Domain:** photography
> **Path:** `style-packages/photographers/saul-leiter`

## Overview

Color street photography built from occlusion, reflections, rain, snow, glass, and muted color fields, turning ordinary proximity into quiet abstraction.
...
Its strongest pull comes from “occlusion, reflection, rain or snow, glass, muted colour, and an uncertain focus within daily life”. The visual order remains clear without a fixed scene.
