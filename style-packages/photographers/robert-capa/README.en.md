...
![Robert Capa representative image](gallery-16x9.jpg)

> **Category:** photographers
> **Type:** photographer
> **Path:** `style-packages/photographers/robert-capa`

## Overview

This independent style package for **Robert Capa** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

近距离纪实、手持动态、人物情绪与不完美胶片. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Robert Capa / 20世纪纪实摄影](https://commons.wikimedia.org/w/index.php?search=Robert+Capa&title=Special:MediaSearch&type=image)
...
The character of this package sits in “close documentary distance, handheld motion, emotional immediacy, and imperfect film presence”. Keep that thread and a new subject can still belong here.
