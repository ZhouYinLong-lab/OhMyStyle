...
![罗伯特·卡帕代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **类型：** 摄影师
> **目录：** `style-packages/photographers/robert-capa`

## 简介

这是一个面向「罗伯特·卡帕」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

近距离纪实、手持动态、人物情绪与不完美胶片。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
这个方向的气质落在“近距离纪实、手持动态、主体情绪与不完美胶片”上。保住这条线索，换成新的主体也能成立。
