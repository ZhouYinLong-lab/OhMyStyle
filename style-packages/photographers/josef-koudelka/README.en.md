...
![Josef Koudelka representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/josef-koudelka`

## Overview

以高反差黑白、开放边缘和全景空间记录流动中的人、地景与历史压力。
...
The useful decision is to open the space first, then let a small person or passing action alter its weight. The package can work with ordinary subjects; it does not need ruins, war, or exile narratives.
