...
> **Domain:** photography
> **Path:** `style-packages/photographers/vivian-maier`

## Overview

Observational street photography using medium-format presence, chance relationships, square or near-square framing, and unembellished natural light.
...
“medium-format street observation, accidental relations, near-square framing, and unperformed daily life” sets the viewing distance. People, objects, and places can change independently.
