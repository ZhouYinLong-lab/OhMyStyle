...
![伊莫金·坎宁安 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/imogen-cunningham`
...
坎宁安的观看很精确，却不冷硬。她常常把复杂主题压缩到一个轮廓、一个生长方向或一处表面细节，让形式自己说话。使用本包时，重点是观察和取舍，不是给画面套上一层黑白滤镜。
