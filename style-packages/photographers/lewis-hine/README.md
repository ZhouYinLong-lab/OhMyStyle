...
![刘易斯·海因 代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **类型：** 摄影师
> **目录：** `style-packages/photographers/lewis-hine`

## 简介

这是一个面向「刘易斯·海因」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
先把“以社会纪实摄影的尊严感、证据式取景、工业尺度、直接的影调描述和劳动者、物件、制度之间的关系建立画面”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
