...
![Josef Sudek representative](gallery-16x9.jpg)

> **Category:** photographer
> **Domain:** photography
> **Path:** `style-packages/photographers/josef-sudek`

## Overview

This package uses quiet light, reflective air, and intimate still-life observation to give ordinary subjects a sense of time through low-key tones.
...
This package suits images that do not rush to explain themselves. Window-like light, reflections, moisture, and gray tones place ordinary objects in quiet time, but the package does not decide that the subject must be a window, garden, or city; the distance of looking should survive the change.
