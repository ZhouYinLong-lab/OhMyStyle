...
![Ansel Adams representative image](gallery-16x9.jpg)

> **Category:** photographers
> **Type:** photographer
> **Path:** `style-packages/photographers/ansel-adams`

## Overview

This independent style package for **Ansel Adams** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

大画幅风景、区域曝光、丰富灰阶与清晰自然细节. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Ansel Adams / 20世纪风景摄影](https://commons.wikimedia.org/w/index.php?search=Ansel+Adams&title=Special:MediaSearch&type=image)
...
The character of this package sits in “large-format clarity, zone-based exposure, rich greys, and precise natural detail”. Keep that thread and a new subject can still belong here.
