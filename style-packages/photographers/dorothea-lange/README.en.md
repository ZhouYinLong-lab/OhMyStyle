...
![Dorothea Lange representative image](gallery-16x9.jpg)

> **Category:** photographers
> **Type:** photographer
> **Path:** `style-packages/photographers/dorothea-lange`

## Overview

This independent style package for **Dorothea Lange** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

社会纪实、直接人物关系、天气纹理与克制灰阶. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Dorothea Lange / 20世纪纪实摄影](https://commons.wikimedia.org/w/index.php?search=Dorothea+Lange&title=Special:MediaSearch&type=image)
...
Start with “direct social observation, weathered surfaces, restrained grey values, and a respectful human scale”. It sets the viewing rhythm while leaving the subject open to your prompt.
