...
![多萝西娅·兰格代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **类型：** 摄影师
> **目录：** `style-packages/photographers/dorothea-lange`

## 简介

这是一个面向「多萝西娅·兰格」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

社会纪实、直接人物关系、天气纹理与克制灰阶。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
我会先看“社会纪实、直接主体关系、天气纹理与克制灰阶”。它把观看节奏定下来，题材可以按你的需要替换。
