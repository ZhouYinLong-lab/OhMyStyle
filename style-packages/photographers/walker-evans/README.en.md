...
![Walker Evans representative image](gallery-16x9.jpg)

> **Category:** photographers
> **Type:** photographer
> **Path:** `style-packages/photographers/walker-evans`

## Overview

This independent style package for **Walker Evans** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

正面建筑、美国日常、几何秩序与深灰层次. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Walker Evans / 20世纪纪实摄影](https://commons.wikimedia.org/w/index.php?search=Walker+Evans&title=Special:MediaSearch&type=image)
...
Start with “frontal architecture, ordinary American detail, geometric order, and deep grey structure”. It sets the viewing rhythm while leaving the subject open to your prompt.
