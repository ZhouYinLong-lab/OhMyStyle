...
![William Eggleston representative image](gallery-16x9.jpg)

> **Category:** photographers
> **Type:** photographer
> **Path:** `style-packages/photographers/william-eggleston`

## Overview

This independent style package for **William Eggleston** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

日常彩色、饱和小物、普通地点与染料转印质感. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [William Eggleston / 新彩色摄影](https://commons.wikimedia.org/w/index.php?search=William+Eggleston&title=Special:MediaSearch&type=image)
...
The character of this package sits in “ordinary colour, saturated small things, unremarkable places, and dye-transfer richness”. Keep that thread and a new subject can still belong here.
