...
![斯蒂芬·肖尔代表图](gallery-16x9.jpg)

> **分类：** 摄影师
> **媒介领域：** 摄影
> **目录：** `style-packages/photographers/stephen-shore`
...
肖尔的照片常让人重新看见那些本来不会停下来看的地方：一排店面、一块空地、路边的线缆和不太协调的停车位置。它们没有被戏剧化，却因为平视、深焦、准确的色彩和克制的构图变得耐看。这个包最值得借鉴的，是把普通场景当成完整的视觉问题，而不是套上一层怀旧滤镜。
