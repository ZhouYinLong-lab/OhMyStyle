# Low-poly Adventure Game Art

[中文](README.md)

![Low-poly Adventure Game Art representative image](gallery-16x9.jpg)

> **Category:** game-art
> **Type:** game-art
> **Path:** `style-packages/game-art/low-poly-adventure-game-art`

## Overview

This independent style package for **Low-poly Adventure Game Art** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

低多边形面、简化材质、清晰光照与可探索空间. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
Start with “low-poly plane, simplified material, clear light, and a space that invites exploration”. It sets the viewing rhythm while leaving the subject open to your prompt.
