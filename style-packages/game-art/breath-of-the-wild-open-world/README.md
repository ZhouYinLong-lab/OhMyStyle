...
![旷野自然开放世界游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/breath-of-the-wild-open-world`

## 简介

以手绘质感的三维自然场景、清晰前中后景、柔和卡通明暗和大尺度探索空间组织可游玩的开放世界画面。
...
我会先看“以手绘质感的三维自然场景、清晰前中后景、柔和卡通明暗和大尺度探索空间组织可游玩的开放世界画面”。它把观看节奏定下来，题材可以按你的需要替换。
