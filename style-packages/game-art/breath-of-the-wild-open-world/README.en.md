# Open-World Painted Nature Game Art

[中文版](README.md)

![Open-World Painted Nature Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/breath-of-the-wild-open-world`

## Overview

A hand-painted 3D nature direction using readable layered depth, soft stylized shading, and spacious exploration scenes.
...
Start with “hand-painted 3D nature, clear depth layers, soft stylized light, and a large space made for exploration”. It sets the viewing rhythm while leaving the subject open to your prompt.
