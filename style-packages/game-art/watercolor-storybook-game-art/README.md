...
![水彩绘本冒险游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/watercolor-storybook-game-art`

## 简介

把可游玩的二维空间处理成带纸张、透明水彩和童话留白的绘本画面，依靠柔和层叠与手绘轮廓保持空间可读性。
...
它最动人的地方是“把可游玩的二维空间处理成带纸张、透明水彩和童话留白的绘本画面，依靠柔和层叠与手绘轮廓保持空间可读性”。画面不依赖固定场景，视觉秩序本身已经很清楚。
