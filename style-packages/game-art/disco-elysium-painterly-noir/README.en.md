# Painterly Noir Graphic-RPG Game Art

[中文版](README.md)

![Painterly Noir Graphic-RPG Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/disco-elysium-painterly-noir`

## Overview

A painterly graphic-RPG direction using dry-brush surfaces, crooked city blocks, wet weather, dirty-soft color, and literary silhouettes.
...
The character of this package sits in “thick paint, skewed city, damp weather, dirty-soft colour, and graphic character silhouette”. Keep that thread and a new subject can still belong here.
