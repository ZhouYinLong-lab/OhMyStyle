...
![最终幻想九绘本幻想游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/final-fantasy-ix-painted-fantasy`

## 简介

手绘背景、简化角色比例和旧绘本纹理；绘本式城镇、夸张轮廓和温暖道具形成可亲近的幻想空间；暖棕、蓝紫、橙黄、草绿和奶油白形成童话色组。
...
它最动人的地方是“手绘背景、简化角色比例和旧绘本纹理；绘本式城镇、夸张轮廓和温暖道具形成可亲近的幻想空间；暖棕、蓝紫、橙黄、草绿和奶油白形成童话色组”。画面不依赖固定场景，视觉秩序本身已经很清楚。
