...
![角色扮演游戏像素美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **类型：** 游戏美术方向
> **目录：** `style-packages/game-art/rpg-maker-pixel-art`

## 简介

这是一个面向「角色扮演游戏像素美术」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
我会先看“以紧凑的角色精灵、清晰的最近邻像素边缘、分层环境、克制的色板和冷暖照明构成 2D 瓦片式游戏画面，可适配探索、对话、解谜、战斗、菜单和转场”。它把观看节奏定下来，题材可以按你的需要替换。
