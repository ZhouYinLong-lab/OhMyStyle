# Painterly 3D Fantasy Game Art

[中文版](README.md)

![Painterly 3D Fantasy Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/painterly-3d-fantasy-game-art`

## Overview

A fantasy game direction combining hand-painted environments, softly modeled 3D subjects, layered atmospheric light, and coherent color temperature.
...
Get “painted environment, soft 3D form, layered light mist, and a shared temperature across scene and form” right first; leave the actual content to your prompt. The style can then travel to another subject.
