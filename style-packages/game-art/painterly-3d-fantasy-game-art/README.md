...
![手绘质感三维幻想游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/painterly-3d-fantasy-game-art`

## 简介

以手绘背景、柔和三维角色和层叠光雾构成幻想游戏空间，强调笔触方向、环境光和角色与景观之间的统一色温。
...
先把“以手绘背景、柔和三维角色和层叠光雾构成幻想游戏空间，强调笔触方向、环境光和角色与景观之间的统一色温”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
