...
![等距手绘策略游戏美术代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/hand-painted-isometric-strategy`
...
我喜欢它把“好看”和“看得懂”放在同一张图里：水、路、地块和建筑各自有材质，也各自有空间位置。生成时先保证等距层级和路径读得清楚，再补手绘细节；如果所有地方都在抢注意力，游戏美术就会失去策略感。
