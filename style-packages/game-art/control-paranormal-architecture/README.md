...
![超现实机关建筑游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/control-paranormal-architecture`

## 简介

以粗野主义建筑、机构化红色标记、荧光灯、深长走廊和单一几何异常组织可解释的超现实空间。
...
先把“以粗野主义建筑、机构化红色标记、荧光灯、深长走廊和单一几何异常组织可解释的超现实空间”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
