# Paranormal Bureaucratic Architecture Game Art

[中文版](README.md)

![Paranormal Bureaucratic Architecture Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/control-paranormal-architecture`

## Overview

A surreal architectural direction built from brutalist institutions, red graphic markers, fluorescent light, deep corridors, and one legible geometric anomaly.
...
Get “brutalist institution, red markers, fluorescent light, long corridors, and one legible geometric anomaly” right first; leave the actual content to your prompt. The style can then travel to another subject.
