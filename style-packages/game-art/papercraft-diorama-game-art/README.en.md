# Papercraft Diorama Game Art

[中文版](README.md)

![Papercraft Diorama Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/papercraft-diorama-game-art`

## Overview

A miniature game-world direction built from cut paper, folds, layered depth, soft cast shadows, and visible handmade variation.
...
“paper plane, fold, cut silhouette, layered relief, and the small errors of hand assembly” sets the viewing distance. People, objects, and places can change independently.
