...
> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/neon-noir-3d-game-art`

## Overview

A 3D noir-game direction using wet urban surfaces, low-key exposure, localized neon color, and believable occlusion rather than a global glow filter.
...
“wet city, low light, local neon, real 3D material, and noir depth through occlusion” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
