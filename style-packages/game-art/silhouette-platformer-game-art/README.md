...
![剪影光影平台游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/silhouette-platformer-game-art`

## 简介

以剪影角色、背光环境、层叠雾气和有限色彩构成平台游戏画面，利用轮廓和光线表达动作、危险与深度。
...
“以剪影角色、背光环境、层叠雾气和有限色彩构成平台游戏画面，利用轮廓和光线表达动作、危险与深度”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
