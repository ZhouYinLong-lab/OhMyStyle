# Silhouette Light-and-Shadow Platformer Game Art
...
> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/silhouette-platformer-game-art`

## Overview

A platformer direction built from readable silhouettes, backlit environments, layered haze, and limited color used to express motion, danger, and depth.
...
“silhouette figure, backlit environment, layered haze, and limited colour used for action and depth” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
