...
![水墨冒险游戏美术代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/ink-wash-adventure`
...
这类游戏美术最重要的不是把画面做成一张水墨明信片，而是让笔墨同时承担空间提示：近处用更有力的线条确认可走的路径，远处用洗染和留白拉开距离，朱色或黛蓝只在需要引导视线时出现。换成室内、人物或物件时，仍要保留这种可探索的层次。
