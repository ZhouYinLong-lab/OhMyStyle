# Cinematic Connected Wilderness Game Art

[中文版](README.md)

![Cinematic Connected Wilderness Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/death-stranding-cinematic-wilderness`

## Overview

A cinematic wilderness direction using enormous negative space, weathered terrain, tiny human scale, and restrained natural light.
...
Start with “large negative space, wind and weather, small human scale, and restrained cinematic daylight”. It sets the viewing rhythm while leaving the subject open to your prompt.
