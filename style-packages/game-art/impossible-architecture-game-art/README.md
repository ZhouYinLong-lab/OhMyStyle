...
![等距幻觉建筑游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/impossible-architecture-game-art`

## 简介

以等距视角、非欧几何连接、干净色面和可操作建筑机关组织谜题场景，画面优先呈现结构关系与视觉错觉。
...
它最动人的地方是“以等距视角、非欧几何连接、干净色面和可操作建筑机关组织谜题场景，画面优先呈现结构关系与视觉错觉”。画面不依赖固定场景，视觉秩序本身已经很清楚。
