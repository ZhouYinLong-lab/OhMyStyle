# Stylized Low-Poly World Game Art
...
> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/stylized-low-poly-world`

## Overview

A stylized 3D world direction built from reduced polygon counts, broad planes, simplified silhouettes, restrained materials, and deliberate lighting.
...
“large planes, simplified contour, restrained material, and clear light over model detail” sets the viewing distance. People, objects, and places can change independently.
