...
![风格化低多边形世界游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/stylized-low-poly-world`

## 简介

通过少量大平面、简化轮廓、克制材质和明确光照构成可探索的低多边形三维世界，强调造型选择而非模型细节。
...
“通过少量大平面、简化轮廓、克制材质和明确光照构成可探索的低多边形三维世界，强调造型选择而非模型细节”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
