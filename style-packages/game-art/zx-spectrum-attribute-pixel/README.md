...
![属性受限像素美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **类型：** 游戏美术方向
> **目录：** `style-packages/game-art/zx-spectrum-attribute-pixel`

## 简介

这是一个面向「属性受限像素美术」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
先把“以粗颗粒像素剪影、硬朗的双颜色块、受限的 15 色硬件色板和明确的色彩冲突管理为核心，优先保证游戏画面在低分辨率下仍然可读”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
