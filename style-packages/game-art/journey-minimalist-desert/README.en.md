# Minimalist Desert Journey Game Art

[中文版](README.md)

![Minimalist Desert Journey Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/journey-minimalist-desert`

## Overview

A reference-backed package for Minimalist Desert Journey Game Art, built around minimalist desert scale, quiet traversal, and soft atmospheric depth.
