...
![平面设计解谜游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/flat-design-puzzle-game-art`

## 简介

用几何形状、纯色面、清楚的交互层级和克制动画语言构成平面解谜画面，强调图形识别和操作逻辑而不是材质复杂度。
...
先把“用几何形状、纯色面、清楚的交互层级和克制动画语言构成平面解谜画面，强调图形识别和操作逻辑而不是材质复杂度”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
