# Flat Design Puzzle Game Art

[中文版](README.md)

![Flat Design Puzzle Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/flat-design-puzzle-game-art`

## Overview

A graphic puzzle-game direction built from geometric shapes, flat color fields, clear interaction hierarchy, and restrained motion cues rather than material complexity.
...
Get “geometric form, flat colour, clear interaction hierarchy, and visual logic over material complexity” right first; leave the actual content to your prompt. The style can then travel to another subject.
