# Neon Ruined-City Game Art

[中文版](README.md)

![Neon Ruined-City Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/stray-neon-cybercity`

## Overview

A lived-in decaying-city direction using low viewpoints, wet concrete, aging apartments, plants, and localized colored lights.
...
Get “low street view, wet concrete, worn apartments, plants, and local colour light with lived-in decay” right first; leave the actual content to your prompt. The style can then travel to another subject.
