...
![微缩模型场景游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/miniature-diorama-game-art`

## 简介

把游戏环境设计成具有微缩模型尺度的立体场景，依靠圆润造型、柔和阴影和小物件比例建立亲切但不幼稚的空间。
...
这个方向的气质落在“把游戏环境设计成具有微缩模型尺度的立体场景，依靠圆润造型、柔和阴影和小物件比例建立亲切但不幼稚的空间”上。保住这条线索，换成新的主体也能成立。
