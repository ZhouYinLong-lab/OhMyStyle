# Hand-Inked Animation Game Art

[中文版](README.md)

![Hand-Inked Animation Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/hand-inked-animation-game-art`

## Overview

A 2D game direction built from hand-inked motion, elastic cartoon anatomy, vintage staging, and watercolor-like backgrounds with deliberate imperfections.
...
Start with “elastic hand-drawn motion, black ink, retro cartoon proportion, and a watercolour background”. It sets the viewing rhythm while leaving the subject open to your prompt.
