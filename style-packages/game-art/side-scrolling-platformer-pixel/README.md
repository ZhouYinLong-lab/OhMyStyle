...
![横版平台跳跃像素美术代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **类型：** 游戏美术
> **目录：** `style-packages/game-art/side-scrolling-platformer-pixel`

## 简介

这是一个面向「横版平台跳跃像素美术」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

横向层次、平台可读性、像素簇与背景视差。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
这个方向的气质落在“横向层次、平台可读性、像素簇与背景视差”上。保住这条线索，换成新的主体也能成立。
