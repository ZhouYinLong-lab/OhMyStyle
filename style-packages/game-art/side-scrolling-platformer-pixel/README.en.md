# Side-scrolling Platformer Pixel Art

[中文](README.md)

![Side-scrolling Platformer Pixel Art representative image](gallery-16x9.jpg)

> **Category:** game-art
> **Type:** game-art
> **Path:** `style-packages/game-art/side-scrolling-platformer-pixel`

## Overview

This independent style package for **Side-scrolling Platformer Pixel Art** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

横向层次、平台可读性、像素簇与背景视差. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
The character of this package sits in “horizontal depth, platform readability, pixel clusters, and parallax distance”. Keep that thread and a new subject can still belong here.
