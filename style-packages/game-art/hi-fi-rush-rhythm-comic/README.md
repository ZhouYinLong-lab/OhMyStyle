...
![节奏漫画卡通渲染游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/hi-fi-rush-rhythm-comic`

## 简介

以厚重轮廓、平面高饱和色、工业舞台、重复节拍形状和夸张动作组织轻快的漫画式三维游戏画面。
...
这个方向的气质落在“以厚重轮廓、平面高饱和色、工业舞台、重复节拍形状和夸张动作组织轻快的漫画式三维游戏画面”上。保住这条线索，换成新的主体也能成立。
