# Grounded Neon Future City Game Art

[中文版](README.md)

![Grounded Neon Future City Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/cyberpunk-night-city`

## Overview

A grounded future-city direction built from vertical density, wet surfaces, layered infrastructure, localized neon, and cinematic night atmosphere.
...
“vertical city, wet ground, dense infrastructure, local neon, and a cinematic night without global glow” sets the viewing distance. People, objects, and places can change independently.
