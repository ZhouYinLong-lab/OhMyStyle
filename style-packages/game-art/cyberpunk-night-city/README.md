...
![霓虹未来都市游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/cyberpunk-night-city`

## 简介

以垂直城市、潮湿路面、密集基础设施、局部霓虹和电影化夜景组织可信的未来都市环境，不依赖全局发光。
...
“以垂直城市、潮湿路面、密集基础设施、局部霓虹和电影化夜景组织可信的未来都市环境，不依赖全局发光”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
