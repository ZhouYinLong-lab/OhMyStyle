# Voxel World Game Art

[中文版](README.md)

![Voxel World Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/voxel-world-game-art`

## Overview

A block-based world direction using modular voxel units, readable stepped terrain, flat material families, and consistent scale from props to landscapes.
...
“stackable cube units, modular terrain, block light, and consistent scale from part to landscape” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
