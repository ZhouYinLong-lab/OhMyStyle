# Stylized PBR Science-Fiction Game Art

[中文版](README.md)

![Stylized PBR Science-Fiction Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/stylized-pbr-sci-fi-game-art`

## Overview

A stylized sci-fi game direction balancing believable PBR responses with graphic color design, readable metal, glass, wet surfaces, and restrained neon.
...
Start with “readable metal, glass, wet surface, neon reflection, and a balance between realism and stylization”. It sets the viewing rhythm while leaving the subject open to your prompt.
