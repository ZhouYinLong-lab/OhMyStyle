# Luminous Hand-Painted Forest Game Art

[中文版](README.md)

![Luminous Hand-Painted Forest Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/ori-luminous-forest`

## Overview

A hand-painted 2D forest direction using flowing roots, luminous leaves, soft atmosphere, and a clear small-scale platforming subject.
...
Its strongest pull comes from “painted 2D forest, flowing roots, luminous leaves, soft air layers, and a readable small form”. The visual order remains clear without a fixed scene.
