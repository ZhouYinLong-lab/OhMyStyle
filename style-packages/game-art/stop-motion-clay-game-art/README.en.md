# Stop-Motion Clay Game Art

[中文版](README.md)

![Stop-Motion Clay Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/stop-motion-clay-game-art`

## Overview

A tactile game direction based on clay characters, welded metal, sewn textiles, miniature woodwork, fingerprints, seams, and stop-motion-like frame-by-frame life.
...
Its strongest pull comes from “handmade clay, welded metal, fabric, miniature woodwork, and visible seams and fingerprints”. The visual order remains clear without a fixed scene.
