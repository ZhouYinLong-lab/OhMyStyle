# Inked Gothic Metroidvania Game Art

[中文版](README.md)

![Inked Gothic Metroidvania Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/hollow-knight-inked-gothic`

## Overview

A reference-backed package for Inked Gothic Metroidvania Game Art, built around inked gothic 2D environment, readable silhouette, and cavernous scale.
...
“inked 2D ground, sparse colour, small scale, deep void, and a quiet gothic silhouette” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
