...
![空洞骑士墨线哥特游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/hollow-knight-inked-gothic`

## 简介

手绘二维背景、墨线轮廓和少量柔和色层；地下遗迹、细小主体和巨大空洞空间由流动墨线与剪影构成；深蓝黑、骨白、锈红、苔绿和冷紫形成压低但清晰的色组。
...
“手绘二维背景、墨线轮廓和少量柔和色层；地下遗迹、细小主体和巨大空洞空间由流动墨线与剪影构成；深蓝黑、骨白、锈红、苔绿和冷紫形成压低但清晰的色组”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
