...
![肯塔基零号公路舞台化游戏美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/kentucky-route-zero-scenographic-game-art`
...
我喜欢它把游戏场景做得像一座可以慢慢走过的舞台：几何体不追求炫技，灯光也不急着制造高潮，真正起作用的是入口、停顿和物件之间的距离。这个包可以迁移到任何环境或主体，不需要每次都回到公路、矿洞或美国小镇。
