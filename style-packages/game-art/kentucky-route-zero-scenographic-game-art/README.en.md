# Kentucky Route Zero Scenographic Game Art

[中文版](README.md)

![Kentucky Route Zero Scenographic Game Art representative](gallery-16x9.jpg)

> **Category:** game_art
> **Domain:** game_art
> **Path:** `style-packages/game-art/kentucky-route-zero-scenographic-game-art`

## Overview

以舞台布景式三维空间、低多边形形体、慢电影镜头和克制灯光，构成可迁移的游戏环境视觉语言。
...
I like how this game-art language treats an environment as a stage that can be crossed slowly: geometry does not chase spectacle, and lighting does not rush toward a climax. Entrances, pauses, and the distance between objects do the work. It can transfer to any subject or environment without returning to a highway, mine, or American small town.
