...
![复古三维主机美术 代表图](gallery-16x9.jpg)

> **分类：** 游戏美术
> **媒介领域：** 游戏美术
> **目录：** `style-packages/game-art/retro-3d-console`
...
复古三维主机美术的魅力不在于“把画面做糊”，而在于限制本身变成了空间语言。低多边形让远近关系更直接，低分辨率纹理会留下拉伸和重复，顶点光照把复杂材质压缩成大块明暗。好的画面仍然要让人知道哪里可以走、哪里是边界、哪个形体值得注意。使用这个包时，先保证空间可探索，再让技术限制自然露出来。
