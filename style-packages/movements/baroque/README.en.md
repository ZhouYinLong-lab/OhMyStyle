...
![Baroque representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/baroque`

## Overview

This independent style package for **Baroque** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

戏剧光线、对角线运动、深暗背景与材质丰富度. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 17世纪](https://commons.wikimedia.org/w/index.php?search=Baroque+painting&title=Special:MediaSearch&type=image)
...
Get “dramatic light, diagonal movement, deep shadow, and richly described material” right first; leave the actual content to your prompt. The style can then travel to another subject.
