...
![精确主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/precisionism`

## 简介

几何化具象、清晰边缘与简化体积；工厂、仓库和桥梁被简化为清楚的几何体，人物很少；白、灰、铁蓝、砖红和黄褐形成工业色组。
...
“几何化具象、清晰边缘与简化体积；工厂、仓库和线性结构被简化为清楚的几何体，主体很少；白、灰、铁蓝、砖红和黄褐形成工业色组”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
