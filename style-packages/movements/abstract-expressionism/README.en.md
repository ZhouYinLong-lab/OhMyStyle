...
![Abstract Expressionism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/abstract-expressionism`

## Overview

A reference-backed package for Abstract Expressionism, built around gestural abstraction, physical paint, and non-central energy.
...
Start with “gestural abstraction, physical paint, open space, and energy that refuses a single centre”. It sets the viewing rhythm while leaving the subject open to your prompt.
