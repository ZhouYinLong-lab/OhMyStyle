...
![Neo-Expressionism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/neo-expressionism`

## Overview

以粗粝笔触、变形具象和强烈色块把情绪压力带回绘画表面，同时保留主体的冲突性。
...
Keep the subject readable first, then let mark-making, proportion, and color blocks push it toward instability. Without that order, dirty colors and irregular lines become decoration rather than structured painting.
