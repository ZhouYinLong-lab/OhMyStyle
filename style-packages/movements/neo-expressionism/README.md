...
![新表现主义代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/neo-expressionism`

## 简介

我喜欢它不把“画得粗”当成效果，而是让每一笔都留下动作：轮廓在挣扎，颜色在碰撞，形体仍然没有彻底消失。它适合给普通主体增加压力和温度，不需要先安排一个戏剧故事。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

先让主体可读，再让笔触、比例和色块把它推向不稳定。这个顺序很重要：如果只有脏颜色和乱线，画面会像装饰性的滤镜，而不是有结构的绘画。
...
参考资料只用于研究和分析。外部作品、商标和网页内容仍归原权利人所有。生成示例是新的匿名场景，不是流派原作，也不代表任何艺术家或机构的合作、授权或背书。
