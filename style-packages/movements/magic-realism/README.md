...
![魔幻现实主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/magic-realism`

## 简介

具象绘画、细节写实与一个超现实但克制的事件；日常空间保持真实，但一个不解释的异常物体改变心理重心；尘土色、灰绿、暗红、乳白和冷蓝形成平静而异样的色组。
...
“具象绘画、细节写实与一个超现实但克制的事件；日常空间保持真实，但一个不解释的异常物体改变心理重心；尘土色、灰绿、暗红、乳白和冷蓝形成平静而异样的色组”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
