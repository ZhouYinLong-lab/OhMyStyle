...
![古希腊古典时期 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派与历史时期
> **类型：** 艺术流派或历史时期
> **目录：** `style-packages/movements/greek-classical-period`

## 简介

这是一个面向「古希腊古典时期」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
这个方向的气质落在“强调均衡构图、清晰而自然的人体、从容的动作、经过组织的衣褶，以及运动、比例和城邦理想之间的秩序关系”上。保住这条线索，换成新的主体也能成立。
