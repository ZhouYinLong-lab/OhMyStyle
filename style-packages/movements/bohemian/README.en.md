...
![Bohemian Style representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/bohemian`

## Overview

以自由混搭、手工材质、旅行物件、自然色彩和不规则层次构成松弛而富有生活痕迹的视觉。
...
“layered textiles, handmade traces, travel-worn objects, natural colour, and relaxed irregularity” sets the viewing distance. People, objects, and places can change independently.
