...
![Art Deco representative image](gallery-16x9.jpg)

> **Category:** movement
> **Type:** design movement
> **Path:** `style-packages/movements/art-deco`

## Overview

This independent style package for **Art Deco** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

阶梯几何、对称、金属色与现代奢华. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various designers / 20世纪20至30年代](https://commons.wikimedia.org/w/index.php?search=Art+Deco+design&title=Special:MediaSearch&type=image)
...
The character of this package sits in “stepped geometry, symmetry, metallic colour, and a polished sense of modern luxury”. Keep that thread and a new subject can still belong here.
