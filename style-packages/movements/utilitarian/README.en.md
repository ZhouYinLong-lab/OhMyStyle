...
![Utilitarian representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/utilitarian`

## Overview

以功能优先、耐用材料、清楚标识、结构诚实和克制装饰建立直接、可靠、可复用的设计视觉。
...
Its strongest pull comes from “function first, durable material, honest structure, clear marking, and restrained decoration”. The visual order remains clear without a fixed scene.
