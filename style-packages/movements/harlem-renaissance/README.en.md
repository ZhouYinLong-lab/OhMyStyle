...
![Harlem Renaissance representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/harlem-renaissance`

## Overview

A reference-backed package for Harlem Renaissance, built around cultural modernism, urban rhythm, and confident decorative color.
...
Get “cultural confidence, graphic plane, music-like rhythm, rich colour, and the presence of the city” right first; leave the actual content to your prompt. The style can then travel to another subject.
