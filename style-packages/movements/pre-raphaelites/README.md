...
![拉斐尔前派 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/pre-raphaelites`

## 简介

细密绘画、植物观察和中世纪式装饰；清晰前景植物、细密人物和装饰性叙事形成高密度平面；宝石绿、深红、蓝、金黄和乳白形成明亮精细色组。
...
这个方向的气质落在“细密绘画、自然形态观察和中世纪式装饰；清晰前景自然形态、细密主体和装饰性叙事形成高密度平面；宝石绿、深红、蓝、金黄和乳白形成明亮精细色组”上。保住这条线索，换成新的主体也能成立。
