...
![Pre-Raphaelite Brotherhood representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/pre-raphaelites`

## Overview

A reference-backed package for Pre-Raphaelite Brotherhood, built around botanical precision, jewel color, and medieval decorative detail.
...
The character of this package sits in “fine detail, plant observation, medieval ornament, and a dense jewel-like surface”. Keep that thread and a new subject can still belong here.
