...
![Renaissance representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/renaissance`

## Overview

A reference-backed package for Renaissance, built around humanist proportion, ordered perspective, and classical clarity.
...
Get “classical drawing, clear contour, stable proportion, perspective, and humanist balance” right first; leave the actual content to your prompt. The style can then travel to another subject.
