...
![Photorealism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/photorealism`

## Overview

A reference-backed package for Photorealism, built around photographic precision, ordinary subject, and controlled realism.
...
Its strongest pull comes from “controlled edge, precise detail, photographic crop, and a cool account of ordinary things”. The visual order remains clear without a fixed scene.
