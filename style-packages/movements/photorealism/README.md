...
![照相写实主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/photorealism`

## 简介

精确绘画或摄影式图像，边缘和细节高度可控；照片式裁切和日常对象被精确还原，画面冷静而无戏剧性；中性灰、真实肤色、车漆色和玻璃反光组成观察性色组。
...
它最动人的地方是“精确绘画或摄影式图像，边缘和细节高度可控；照片式裁切和日常对象被精确还原，画面冷静而无戏剧性；中性灰、真实肤色、车漆色和玻璃反光组成观察性色组”。画面不依赖固定场景，视觉秩序本身已经很清楚。
