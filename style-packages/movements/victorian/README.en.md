...
![Victorian representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/victorian`

## Overview

以19世纪装饰秩序、繁复纹样、深色木材、织物层次和结构化室内细节形成历史感视觉。
...
“nineteenth-century ornament, dark wood, layered fabric, and structured interior detail” sets the viewing distance. People, objects, and places can change independently.
