...
![非形式艺术代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/art-informel`
...
我喜欢它把“画面”重新变成一件有重量的东西：刮痕、堆积和被覆盖的层次都留下了施力的方向。生成时应让材料先承担结构，再考虑装饰性颜色；如果只叠一层旧纹理，得到的会是滤镜，而不是材料语言。
