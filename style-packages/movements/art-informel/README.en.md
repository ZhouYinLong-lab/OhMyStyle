...
![Art Informel representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/art-informel`

## Overview

以反几何构成、偶发痕迹、材料厚度和松散手势拒绝整齐的形式秩序。
...
The image should feel like an object with weight: scraping, deposits, and buried
layers retain the direction of physical pressure. Let material carry the structure
before adding decorative color; a single aged-texture overlay is only a filter,
not a material language.
