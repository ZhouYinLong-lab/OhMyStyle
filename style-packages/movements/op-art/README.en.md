...
![Op Art representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/op-art`

## Overview

A reference-backed package for Op Art, built around optical vibration, repeated geometry, and precise flat print.
...
“hard geometry, repeated pattern, optical vibration, and a flat field with strict contrast” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
