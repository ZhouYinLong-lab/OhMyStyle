...
![欧普艺术 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/op-art`

## 简介

硬边几何、重复图案和视错觉结构；重复线条、网格和波纹制造视觉震动，画面保持平面；黑白为主，辅以单一红或蓝强调色。
...
“硬边几何、重复图案和视错觉结构；重复线条、网格和波纹制造视觉震动，画面保持平面；黑白为主，辅以单一红或蓝强调色”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
