# Mystical Western / Tarot

[中文版](README.md)

![Mystical Western / Tarot representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/mystical-western-tarot`

## Overview

以西部荒野符号、塔罗式构图、象征性物件、旧纸张和神秘叙事建立可读但不依赖固定角色的视觉。
