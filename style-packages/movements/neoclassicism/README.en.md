...
![Neoclassicism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/neoclassicism`

## Overview

This independent style package for **Neoclassicism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

清晰轮廓、古典建筑、平衡几何与雕塑式人体. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 18至19世纪](https://commons.wikimedia.org/w/index.php?search=Neoclassical+painting&title=Special:MediaSearch&type=image)
...
Get “clear contour, classical proportion, balanced geometry, and sculptural volume” right first; leave the actual content to your prompt. The style can then travel to another subject.
