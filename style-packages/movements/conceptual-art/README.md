...
![观念艺术 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/conceptual-art`

## 简介

现成物、文档式摄影和文字结构的视觉替代，但画面不出现可读文字；一个简单规则或观念决定物件排列，形式故意保持克制；白、黑、纸灰、红色标记和自然色形成概念性对比。
...
这个方向的气质落在“现成物、文档式摄影和文字结构的视觉替代，但画面不出现可读文字；一个简单规则或观念决定物件排列，形式故意保持克制；白、黑、纸灰、红色标记和自然色形成概念性对比”上。保住这条线索，换成新的主体也能成立。
