...
![Conceptual Art representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/conceptual-art`

## Overview

A reference-backed package for Conceptual Art, built around rule-based arrangement, documentary restraint, and conceptual clarity.
...
The character of this package sits in “a simple rule, found material, document-like restraint, and an arrangement that carries the idea”. Keep that thread and a new subject can still belong here.
