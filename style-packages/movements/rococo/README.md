...
![洛可可代表图](gallery-16x9.jpg)

> **分类：** 艺术流派与历史时期
> **类型：** 艺术流派
> **目录：** `style-packages/movements/rococo`

## 简介

这是一个面向「洛可可」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

轻盈花园、粉彩、非对称姿态与精致装饰。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
“轻盈开放空间、粉彩、非对称姿态与精致装饰”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
