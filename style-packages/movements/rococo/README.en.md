...
![Rococo representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/rococo`

## Overview

This independent style package for **Rococo** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

轻盈花园、粉彩、非对称姿态与精致装饰. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 18世纪](https://commons.wikimedia.org/w/index.php?search=Rococo+painting&title=Special:MediaSearch&type=image)
...
“light garden atmosphere, pastel colour, asymmetrical pose, and delicate ornament” sets the viewing distance. People, objects, and places can change independently.
