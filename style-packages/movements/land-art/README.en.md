...
![Land Art representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/land-art`

## Overview

A reference-backed package for Land Art, built around earth intervention, monumental scale, and natural weathering.
...
Get “earth, stone, salt, field intervention, and a clear scale relation between mark and landscape” right first; leave the actual content to your prompt. The style can then travel to another subject.
