...
![Arts and Crafts Movement representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/arts-and-crafts`

## Overview

A reference-backed package for Arts and Crafts Movement, built around honest craft, organic pattern, and integrated useful design.
...
Its strongest pull comes from “handmade material, useful objects, patterned surface, and a coherent relation between craft and space”. The visual order remains clear without a fixed scene.
