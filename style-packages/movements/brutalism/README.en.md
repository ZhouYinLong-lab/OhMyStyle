...
![Brutalism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/brutalism`

## Overview

以裸露结构、厚重体块、粗粝材质、强烈比例和直接功能表达建立不修饰的建筑与平面视觉。
...
Start with “exposed structure, heavy mass, rough material, forceful proportion, and direct function”. It sets the viewing rhythm while leaving the subject open to your prompt.
