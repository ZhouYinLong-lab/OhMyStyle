...
![Post-Impressionism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/post-impressionism`

## Overview

This independent style package for **Post-Impressionism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

结构化色块、主观色彩、稳定形体与可见笔触. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 19世纪末](https://commons.wikimedia.org/w/index.php?search=Post-Impressionism+painting&title=Special:MediaSearch&type=image)
...
Start with “structured colour, subjective hue, solid form, and visible directional touch”. It sets the viewing rhythm while leaving the subject open to your prompt.
