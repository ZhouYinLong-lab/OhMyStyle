...
![Memphis representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/memphis`

## Overview

以几何形体、明亮撞色、装饰性图案和不对称组合打破严肃功能主义，形成 playful 的平面空间。
...
The character of this package sits in “geometric shape, bright contrast, decorative pattern, asymmetry, and playful flat space”. Keep that thread and a new subject can still belong here.
