...
![浮世绘 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 版画
> **目录：** `style-packages/movements/ukiyo-e`

## 简介

浮世绘是与城市出版、旅行图像、戏剧、服饰和季节观察密切相关的多色木版画传统。这个包关注套色、刻线、裁切、图案和装饰性平面如何组织画面，不把桥、灯笼、和服或日本街景设为默认主体。

## 策展短评

它的魅力不只在“日式”外观，而在于把复杂场景编辑成一眼可读的色层和轮廓。代表图使用街景，是为了显示裁切、水平节奏和局部图案；换成植物、建筑或普通器物时，这套组织方法仍应成立。
