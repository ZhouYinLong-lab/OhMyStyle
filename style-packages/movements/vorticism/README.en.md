...
![Vorticism representative image](gallery-16x9.jpg)
...
This package translates observable visual decisions associated with Vorticism into reusable generation rules. It is designed for new subjects, not for copying a specific source work.

## Curatorial note

Vorticism is not simply an industrial look，It is closer to把运动压缩成几何断面：硬边、折线、冲突的方向和突然收紧的中心共同制造能量。适合用在需要张力的主体上，但不该强迫每张图出现机器或城市。
