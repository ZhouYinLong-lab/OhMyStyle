...
![Gothic representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/gothic`

## Overview

以垂直性、尖拱、深色材质、宗教象征和复杂装饰建立庄严、神秘且结构明确的历史视觉。
...
Get “vertical structure, pointed rhythm, dark material, symbolic detail, and intricate ornament” right first; leave the actual content to your prompt. The style can then travel to another subject.
