...
![Art Nouveau representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/art-nouveau`

## Overview

This independent style package for **Art Nouveau** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

鞭梢曲线、植物形态、平面装饰与柔和珠宝色. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
“whiplash curves, plant forms, flat ornament, and soft jewel-like colour” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
