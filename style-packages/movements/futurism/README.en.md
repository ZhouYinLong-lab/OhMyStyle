...
![Futurism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/futurism`

## Overview

This independent style package for **Futurism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

速度、重复节奏、对角线力量、城市机械感. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 20世纪初](https://commons.wikimedia.org/w/index.php?search=Futurism+painting&title=Special:MediaSearch&type=image)
...
Its strongest pull comes from “speed, repeated rhythm, diagonal force, and the mechanical energy of a city”. The visual order remains clear without a fixed scene.
