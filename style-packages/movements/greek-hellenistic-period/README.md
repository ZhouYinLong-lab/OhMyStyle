...
![古希腊化时期 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派与历史时期
> **类型：** 艺术流派或历史时期
> **目录：** `style-packages/movements/greek-hellenistic-period`

## 简介

这是一个面向「古希腊化时期」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
它最动人的地方是“用强烈斜线、扭转姿态、情绪张力、多样化人体和戏剧化空间表现希腊化时期的能量，同时保留希腊与东地中海文化交流的痕迹”。画面不依赖固定场景，视觉秩序本身已经很清楚。
