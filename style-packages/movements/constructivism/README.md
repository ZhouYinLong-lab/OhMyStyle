...
![构成主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/constructivism`

## 简介

几何构成、印刷设计与工业材料感；对角线、圆弧、网格和机械结构构成强烈的平面空间；黑、白、红、黄和工业灰形成革命性几何色组。
...
“几何构成、印刷设计与工业材料感；对角线、圆弧、网格和机械结构构成强烈的平面空间；黑、白、红、黄和工业灰形成革命性几何色组”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
