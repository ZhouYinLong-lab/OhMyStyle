...
![Vaporwave representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/vaporwave`

## Overview

以消费媒介怀旧、低清数字质感、粉紫青色调、古典雕像隐喻和错位排版构成网络亚文化视觉。
...
Get “consumer-media nostalgia, low-resolution digital texture, pastel neon, classical quotation, and displaced type” right first; leave the actual content to your prompt. The style can then travel to another subject.
