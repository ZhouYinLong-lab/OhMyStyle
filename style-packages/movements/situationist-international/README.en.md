...
![Situationist International representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/situationist-international`

## Overview

以城市漂移、断裂地图、拼贴文本和对消费空间的重新编排，制造开放而批判性的视觉场景。
...
I like how this package turns walking into a compositional method: routes break apart, familiar space is reassembled, and the viewer must find a direction. It works well with posters, maps, streets, and interfaces, but political slogans are not the style itself. The transferable decisions are drift, cutting, and redirected attention.
