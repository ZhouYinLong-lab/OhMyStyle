...
![情境主义国际 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 设计
> **目录：** `style-packages/movements/situationist-international`
...
我喜欢它把“走路”变成一种构图方法：路线被打断，熟悉的空间被重新拼接，观看者需要自己寻找方向。它很适合海报、地图、城市和界面等材料，但不要把政治口号当成风格本身；真正值得复用的是漂移、切割和重新导向。
