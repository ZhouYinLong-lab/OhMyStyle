...
![Vienna Secession representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/vienna-secession`

## Overview

以平面装饰、几何秩序、象征性图形和建筑—平面—工艺的整体关系组织画面。
...
The Vienna Secession is not simply a gold surface. Its useful idea is the integration of frame, ornament, typography-like structure, and subject into one visual order. This package turns ordinary subjects into a coherent decorative system while keeping the geometry legible.
