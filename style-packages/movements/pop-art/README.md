...
![波普艺术 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/pop-art`

## 简介

丝网印刷、硬边平涂、重复和商业图像语法；日常商品、广告式裁切和重复图像形成平面冲击；正红、亮黄、宝蓝、黑和纸白形成高纯度印刷色组。
...
“丝网印刷、硬边平涂、重复和商业图像语法；日常商品、广告式裁切和重复图像形成平面冲击；正红、亮黄、宝蓝、黑和纸白形成高纯度印刷色组”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
