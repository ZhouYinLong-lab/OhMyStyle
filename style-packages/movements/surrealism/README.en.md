...
![Surrealism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/surrealism`

## Overview

This independent style package for **Surrealism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

梦境逻辑、日常错位、清晰质感与非理性连接. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 20世纪](https://commons.wikimedia.org/w/index.php?search=Surrealism+painting&title=Special:MediaSearch&type=image)
...
“dream logic, everyday displacement, clear texture, and connections that refuse ordinary reason” sets the viewing distance. People, objects, and places can change independently.
