...
![新地形摄影 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派与历史时期
> **类型：** 摄影流派与摄影史传统
> **目录：** `style-packages/movements/new-topographics`

## 简介

这是一个面向「新地形摄影」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
我会先看“以清醒地观看被人类改造的地形为核心，保持克制构图、中性描述和文献证据感，同时让纪实记录与审美秩序之间的张力自然存在”。它把观看节奏定下来，题材可以按你的需要替换。
