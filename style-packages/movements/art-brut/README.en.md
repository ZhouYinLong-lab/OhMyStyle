...
![Art Brut representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** hybrid
> **Path:** `style-packages/movements/art-brut`

## Overview

以未经学院规范驯化的线条、重复、密集痕迹和非标准材料感，保留直接、私人且不完美的视觉生成过程。
...
Art Brut is not one unified look, and it should not become a label for a type of person. This package extracts observable working traces: repetition, covering, misalignment, non-standard materials, and process that has not been polished away. It keeps a subject's private order and imperfection without imitating an artist's biography.
