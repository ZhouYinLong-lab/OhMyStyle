...
![达达主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/dada`

## 简介

拼贴、现成物、照片碎片和粗糙排版痕迹；现成物、错位比例和拼贴版面打断传统构图秩序；黑白、广告红、酸黄、灰纸和工业蓝形成冲突色组。
...
“拼贴、现成物、照片碎片和粗糙排版痕迹；现成物、错位比例和拼贴版面打断传统构图秩序；黑白、广告红、酸黄、灰纸和工业蓝形成冲突色组”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
