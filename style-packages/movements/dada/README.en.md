...
![Dada representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/dada`

## Overview

A reference-backed package for Dada, built around anti-art collage, found-object disruption, and tactile paper edges.
...
“collage fragments, found material, rough typography, displaced scale, and deliberate interruption” sets the viewing distance. People, objects, and places can change independently.
