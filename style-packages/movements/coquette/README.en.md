...
![Coquette representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/coquette`

## Overview

以蝴蝶结、柔和粉彩、细腻织物、轻盈装饰和浪漫细节构成精致但不固定人物身份的少女感视觉。
...
Its strongest pull comes from “soft pastel, ribbon-like detail, delicate fabric, and a light romantic surface”. The visual order remains clear without a fixed scene.
