...
![Graffiti representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/graffiti`

## Overview

以手写笔触、喷漆边缘、叠写层次、城市表面和高能色块构成直接而有现场感的视觉语言。
...
“hand lettering, spray edges, layered marks, urban surfaces, and high-energy colour” sets the viewing distance. People, objects, and places can change independently.
