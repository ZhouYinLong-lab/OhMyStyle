...
![Romanticism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/romanticism`

## Overview

This independent style package for **Romanticism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

崇高景观、天气、情绪尺度与暖冷光线. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 19世纪](https://commons.wikimedia.org/w/index.php?search=Romanticism+painting&title=Special:MediaSearch&type=image)
...
Start with “sublime scale, weather, emotional distance, and warm–cool light”. It sets the viewing rhythm while leaving the subject open to your prompt.
