...
![象征主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/symbolism`

## 简介

平面化绘画、梦境意象与装饰性轮廓；现实场景被一两个心理象征物打断，构图宁静而不解释；深蓝、紫黑、月白、暗红和金黄形成梦境色组。
...
我会先看“平面化绘画、梦境意象与装饰性轮廓；现实场景被一两个心理象征物打断，构图宁静而不解释；深蓝、紫黑、月白、暗红和金黄形成梦境色组”。它把观看节奏定下来，题材可以按你的需要替换。
