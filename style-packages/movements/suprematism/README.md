...
![至上主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/suprematism`

## 简介

纯几何抽象与硬边平涂；基本几何形体漂浮于开放底面，重力和比例被悬置；白、黑、红、蓝和黄形成纯净色面。
...
先把“纯几何抽象与硬边平涂；基本几何形体漂浮于开放底面，重力和比例被悬置；白、黑、红、蓝和黄形成纯净色面”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
