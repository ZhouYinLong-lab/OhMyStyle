...
![Suprematism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/suprematism`

## Overview

A reference-backed package for Suprematism, built around pure geometric abstraction, floating forms, and hard-edge color.
...
Get “pure geometry, hard-edge flatness, open ground, suspended proportion, and clean primary colour” right first; leave the actual content to your prompt. The style can then travel to another subject.
