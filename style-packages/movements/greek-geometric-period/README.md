...
![古希腊几何时期 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派与历史时期
> **类型：** 艺术流派或历史时期
> **目录：** `style-packages/movements/greek-geometric-period`

## 简介

这是一个面向「古希腊几何时期」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
“以有序的横向带状分区、棱角化人体、重复符号和葬礼行列建立早期希腊视觉系统，并保持陶土、黑色与奶油色的材料感”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
