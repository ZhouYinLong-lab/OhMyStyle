...
![Expressionism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/expressionism`

## Overview

This independent style package for **Expressionism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

情绪变形、尖锐轮廓、强烈色彩与心理空间. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 20世纪初](https://commons.wikimedia.org/w/index.php?search=Expressionism+painting&title=Special:MediaSearch&type=image)
...
The character of this package sits in “distorted form, sharp contour, charged colour, and a space shaped by inner pressure”. Keep that thread and a new subject can still belong here.
