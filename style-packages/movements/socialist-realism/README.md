...
![社会主义现实主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/socialist-realism`

## 简介

具象绘画、清楚轮廓和公共叙事构图；人物群体、劳动动作和清楚背景形成可读的公共场景；红、赭土、天蓝、暖灰和肤色形成正面但不霓虹的色组。
...
“具象绘画、清楚轮廓和公共叙事构图；主体群体、劳动动作和清楚背景形成可读的公共场景；红、赭土、天蓝、暖灰和肤色形成正面但不霓虹的色组”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
