# Chinese Literati Ink Painting

[中文版](README.md)

![Chinese Literati Ink Painting representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/chinese-literati-ink-painting`

## Overview

Chinese literati ink painting treats brush, paper, and viewing rhythm as one system: value, wetness, speed, and blank space all participate in form. This package extracts that open brush structure; bamboo, mountains, pavilions, seals, and scroll formats are not defaults.

## Curatorial note

It suits subjects that need breathing room and understated layers. The representative winter hillside makes blank space, pale distance, and a few dark strokes easy to inspect; the same density relationship should survive when the subject becomes an ordinary object or a person.
