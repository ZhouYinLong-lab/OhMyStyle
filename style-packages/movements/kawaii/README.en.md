...
![Kawaii representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/kawaii`

## Overview

以圆润轮廓、简化表情、柔和或糖果色彩和亲和比例构成轻松可爱的视觉，不限定具体角色。
...
Its strongest pull comes from “rounded contour, simplified expression, soft or candy colour, and friendly proportion”. The visual order remains clear without a fixed scene.
