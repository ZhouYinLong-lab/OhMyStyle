...
![Realism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/realism`

## Overview

This independent style package for **Realism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

普通劳动、直接观察、非理想化人物与土色重量. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 19世纪](https://commons.wikimedia.org/w/index.php?search=Realism+painting&title=Special:MediaSearch&type=image)
...
Its strongest pull comes from “direct observation, ordinary labour, unidealized form, and the weight of earthy colour”. The visual order remains clear without a fixed scene.
