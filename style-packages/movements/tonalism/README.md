...
![色调主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/tonalism`

## 简介

以相近色阶、柔和空气和被雾化的远近关系建立低声部画面，而不是依赖鲜艳颜色或明确轮廓。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

色调主义的魅力不只是“画面变灰”，而是让相近的色阶互相托住，再用很小的对比把主体从空气里捞出来。它可以服务风景，也可以服务一件普通物品；真正稳定的是空气感和价值层次，不是题材。
