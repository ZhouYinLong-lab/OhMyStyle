...
![Tonalism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/tonalism`

## Overview

This package builds a low-key image from related tones, soft atmosphere, and receding edges rather than bright color or hard outlines.
...
Tonalism is not simply “making the image gray.” It lets neighboring values support one another, then uses a small amount of contrast to lift the subject out of the air. It can serve a landscape or an ordinary object; what stays stable is the atmosphere and value structure, not the topic.
