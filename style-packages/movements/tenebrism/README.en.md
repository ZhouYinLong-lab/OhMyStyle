...
![Tenebrism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/tenebrism`

## Overview

以大面积暗部包围局部强光、深色背景和戏剧性明暗分割建立集中而有体积感的画面秩序。
...
“broad dark mass, concentrated light, deep ground, and a strong division of volume” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
