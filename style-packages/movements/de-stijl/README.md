...
![荷兰风格派代表图](gallery-16x9.jpg)

> **分类：** 艺术流派与历史时期
> **目录：** `style-packages/movements/de-stijl`

## 简介

这是一个面向「荷兰风格派」的独立风格包。它把公开资料与可观察的媒介、构图、色彩、光线、材质和纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

以水平垂直关系、矩形色面、黑线结构和非对称平衡建立清晰空间；强调构成逻辑，而不是把它简化为几块彩色几何图形。
...
我会先看“以水平垂直关系、矩形色面、黑线结构和非对称平衡建立清晰空间；强调构成逻辑，而不是把它简化为几块彩色几何图形”。它把观看节奏定下来，题材可以按你的需要替换。
