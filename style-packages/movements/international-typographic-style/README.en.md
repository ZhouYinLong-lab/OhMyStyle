...
![International Typographic Style representative image](gallery-16x9.jpg)

> **Category:** movement
> **Type:** design movement
> **Path:** `style-packages/movements/international-typographic-style`

## Overview

This independent style package for **International Typographic Style** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

网格、无衬线秩序、非对称留白与清晰信息层级. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Swiss designers / 20世纪50至60年代](https://commons.wikimedia.org/w/index.php?search=Swiss+Style+graphic+design&title=Special:MediaSearch&type=image)
...
Start with “grid, sans-serif order, asymmetric space, and a clear hierarchy of information”. It sets the viewing rhythm while leaving the subject open to your prompt.
