...
![国际主义版式风格代表图](gallery-16x9.jpg)

> **分类：** 艺术流派与历史时期
> **类型：** 设计运动
> **目录：** `style-packages/movements/international-typographic-style`

## 简介

这是一个面向「国际主义版式风格」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

网格、无衬线秩序、非对称留白与清晰信息层级。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
我会先看“网格、无衬线秩序、非对称留白与清晰信息层级”。它把观看节奏定下来，题材可以按你的需要替换。
