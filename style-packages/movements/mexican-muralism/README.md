...
![墨西哥壁画运动代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/mexican-muralism`

## 简介

以公共尺度的整体构图、坚实轮廓、分层色块和壁面叙事秩序组织视觉信息，强调画面结构的可读性与公共空间感。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

我喜欢它对“远看先读结构，近看再发现痕迹”的坚持。生成时先把画面当成一面公共尺度的墙：用几块大色面和轮廓安排关系，再让人物、建筑或用户指定的主体进入其中。历史题材只是它曾经承担过的任务，不应成为每次生成的剧情模板。
