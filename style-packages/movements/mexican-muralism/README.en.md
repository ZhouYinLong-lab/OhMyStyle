...
![Mexican Muralism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/mexican-muralism`

## Overview

Public-scale composition, firm contour masses, layered color fields, and wall-like
readability organize the image without requiring a particular story or subject.
...
The useful quality is “read the structure from far away, then discover the marks
up close.” Treat the image as a public-scale surface: establish a few large color
fields and contour relationships before introducing the user's subject. Historical
themes are part of the movement's context, not a story template for every image.
