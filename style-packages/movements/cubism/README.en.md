...
![Cubism representative image](gallery-16x9.jpg)

> **Category:** movements
> **Type:** movement
> **Path:** `style-packages/movements/cubism`

## Overview

This independent style package for **Cubism** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

多视点、切面、浅空间与结构化静物. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various artists / 20世纪初](https://commons.wikimedia.org/w/index.php?search=Cubism+painting&title=Special:MediaSearch&type=image)
...
Get “multiple viewpoints, faceted form, shallow space, and a structured relation between object and plane” right first; leave the actual content to your prompt. The style can then travel to another subject.
