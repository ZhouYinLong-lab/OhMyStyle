...
![极简主义 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/minimalism`

## 简介

工业几何体、硬边表面与极少装饰；少量基本形体占据宽阔空间，比例和间距成为主体；白、灰、黑、冷蓝和单一强调色形成低噪声色组。
...
它最动人的地方是“工业几何体、硬边表面与极少装饰；少量基本形体占据宽阔空间，比例和间距成为主体；白、灰、黑、冷蓝和单一强调色形成低噪声色组”。画面不依赖固定场景，视觉秩序本身已经很清楚。
