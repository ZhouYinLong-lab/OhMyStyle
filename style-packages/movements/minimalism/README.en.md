...
![Minimalism representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/minimalism`

## Overview

A reference-backed package for Minimalism, built around reduced geometry, industrial surface, and measured negative space.
...
Its strongest pull comes from “few basic forms, hard surfaces, wide space, exact interval, and low-noise colour”. The visual order remains clear without a fixed scene.
