...
![Japandi representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** design
> **Path:** `style-packages/movements/japandi`

## Overview

融合日式克制与北欧功能主义，以自然材质、低饱和色彩、留白和简洁比例建立安静空间。
...
“natural material, low saturation, open space, simple proportion, and quiet function” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
