...
![北方文艺复兴 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/northern-renaissance`

## 简介

细密油画、透明釉层与超写实小物；室内细节、反射物和小尺度象征共同构成精密叙事；深红、墨绿、金黄、木棕和铅白形成细密色组。
...
这个方向的气质落在“细密油画、透明釉层与超写实小物；室内细节、反射物和小尺度象征共同构成精密叙事；深红、墨绿、金黄、木棕和铅白形成细密色组”上。保住这条线索，换成新的主体也能成立。
