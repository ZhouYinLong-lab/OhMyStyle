...
![野兽主义代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/fauvism`
...
野兽主义的冲击力不只是把颜色调得更艳，而是让颜色不再服从“树必须是绿的、影子必须是黑的”这种说明任务。代表图里，蓝色可以成为轮廓，紫色可以成为远山，橙色和黄色共同承担地面与光线；但形体仍然清楚，笔触仍然顺着空间走。换成别的主体时，要保留这种有结构的自由。
