...
![抒情抽象 代表图](gallery-16x9.jpg)

> **分类：** 艺术流派
> **媒介领域：** 绘画
> **目录：** `style-packages/movements/lyrical-abstraction`

## 简介

以身体性的笔触、开放边界、流动色层和不规则节奏，让绘画过程成为画面结构的一部分。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

我更愿意把它理解成“让绘画动作留在画面里”，而不是给抽象图套一层潦草纹理。真正值得保留的是手势的方向、颜料的叠压和空白的停顿；主体可以很小，也可以在过程中逐渐消失。
