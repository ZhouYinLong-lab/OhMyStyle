...
![Lyrical Abstraction representative](gallery-16x9.jpg)

> **Category:** movement
> **Domain:** painting
> **Path:** `style-packages/movements/lyrical-abstraction`

## Overview

This package lets the act of painting remain visible through bodily gesture, open edges, flowing layers, and irregular rhythm.
...
I think of it as keeping the motion of painting in the image, rather than placing a rough texture over an abstract picture. What matters is the direction of the gesture, the pressure between layers, and the pauses of open ground; the subject may stay small or gradually dissolve.
