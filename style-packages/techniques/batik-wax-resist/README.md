...
![蜡染防染工艺 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/batik-wax-resist`
...
这个包最有意思的地方是，图案不是先画出来再贴到布上，而是由防染、浸染、开裂和吸收一步步留下痕迹。生成时不必依赖某种固定纹样；只要让蜡线、染层和布纹真正参与构图，换成不同主体也能保持工艺感。
