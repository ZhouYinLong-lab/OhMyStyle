...
![Batik Wax-Resist Dyeing representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** printmaking
> **Path:** `style-packages/techniques/batik-wax-resist`

## Overview

以熔蜡防染、分层上色、裂纹渗色和织物吸收，形成由工艺顺序决定的图案与表面节奏。
...
The distinctive part of this package is that the pattern is not simply drawn onto cloth. It is left by resist, dye baths, cracking, and absorption in sequence. Do not depend on a fixed motif; let wax lines, dye layers, and weave participate in the composition so the process can travel to different subjects.
