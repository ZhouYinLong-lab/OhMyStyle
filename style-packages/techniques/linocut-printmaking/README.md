...
![油毡版画 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 绘画
> **目录：** `style-packages/techniques/linocut-printmaking`

## 简介

油毡刻线、平面油墨和套色印刷；黑白或双色块以强轮廓、负形和切刀方向组织画面；黑、纸白、靛蓝、砖红和赭黄形成版画色组。
...
“油毡刻线、平面油墨和套色印刷；黑白或双色块以强轮廓、负形和切刀方向组织画面；黑、纸白、靛蓝、砖红和赭黄形成版画色组”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
