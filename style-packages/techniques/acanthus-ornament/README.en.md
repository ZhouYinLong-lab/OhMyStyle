...
![Acanthus Ornament representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** design
> **Path:** `style-packages/techniques/acanthus-ornament`

## Overview

以莨苕叶的卷曲叶脉、对称节奏和浮雕式层叠组织古典装饰边框与表面结构。
...
Start with “curled leaf veins, symmetrical rhythm, and relief-like layers shaping an ornamental surface”. It sets the viewing rhythm while leaving the subject open to your prompt.
