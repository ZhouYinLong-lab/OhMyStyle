...
![Collage Mixed Media representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** painting
> **Path:** `style-packages/techniques/collage-mixed-media`

## Overview

A reference-backed package for Collage Mixed Media, built around cut paper, material layering, and visible hand-built edges.
...
“cut, torn, pasted, printed, and painted layers building a discontinuous material space” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
