...
![Screen Printing representative image](gallery-16x9.jpg)

> **Category:** techniques
> **Directory:** `style-packages/techniques/screen-printing`
...
Builds screen-print results from opaque ink layers, limited separations, registration shifts, paper grain, and deliberate reduction for posters, packaging, illustration, and graphic marks.
