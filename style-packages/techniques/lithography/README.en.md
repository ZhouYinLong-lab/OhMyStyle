...
![Lithography representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** printmaking
> **Path:** `style-packages/techniques/lithography`

## Overview

以平版油水相斥、石面绘制和多次套印建立柔和颗粒、线条与色层的印刷质感。
...
The useful decision is to split the subject into print layers before deciding where paper should remain visible. That lets the process transfer to architecture, people, or abstract forms instead of being tied to one still life.
