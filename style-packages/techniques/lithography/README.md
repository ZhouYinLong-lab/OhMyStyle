...
![石版画代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/lithography`

## 简介

我喜欢石版画里那种既平又有触感的矛盾：颜色像被压进纸里，线条却保留手的速度。它不靠怀旧滤镜成立，而是靠墨层、纸白和轻微错位让画面有真实的制作过程。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

最值得尝试的是先把主体拆成几层印刷关系，再决定哪些地方留纸、哪些地方压墨。这样换成建筑、人物或抽象形体，工艺仍然能迁移，不会被某一组静物绑住。
...
参考资料只用于研究和分析。外部版画、商标和网页内容仍归原权利人所有。生成示例是新的匿名场景，不是具体版画的复制，也不代表任何艺术家或机构的合作、授权或背书。
