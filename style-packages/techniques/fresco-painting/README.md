...
![湿壁画 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 绘画
> **目录：** `style-packages/techniques/fresco-painting`

## 简介

湿灰泥上的矿物颜料、平面壁画与建筑尺度；建筑墙面、连续叙事和稳定人物群组形成公共空间画面；石灰白、赭红、群青、土黄和灰绿形成矿物色组。
...
“湿灰泥上的矿物颜料、平面壁画与建筑尺度；建筑墙面、连续叙事和稳定主体群组形成公共空间画面；石灰白、赭红、群青、土黄和灰绿形成矿物色组”是很好的入口：它先安排画面的呼吸，再让具体内容进入。
