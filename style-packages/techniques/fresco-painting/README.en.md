...
![Fresco Painting representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** painting
> **Path:** `style-packages/techniques/fresco-painting`

## Overview

A reference-backed package for Fresco Painting, built around mineral pigment in plaster, architectural scale, and aged wall surface.
...
“mineral pigment, plaster surface, flat wall scale, and a steady public composition” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
