...
![Oil Painting representative image](gallery-16x9.jpg)

> **Category:** techniques
> **Type:** technique
> **Path:** `style-packages/techniques/oil-painting`

## Overview

This independent style package for **Oil Painting** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

分层油膜、可见笔触、透明罩染与体积塑造. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various painters / 跨时期技法](https://commons.wikimedia.org/w/index.php?search=oil+painting+technique&title=Special:MediaSearch&type=image)
...
“layered oil film, visible stroke, transparent glaze, and volume built through paint” is the useful entry point: it arranges the image’s breathing room before the subject arrives.
