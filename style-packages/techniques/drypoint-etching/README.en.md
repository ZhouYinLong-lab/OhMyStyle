...
![Drypoint Etching representative image](gallery-16x9.jpg)

> **Category:** techniques
> **Type:** technique
> **Path:** `style-packages/techniques/drypoint-etching`

## Overview

This independent style package for **Drypoint Etching** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

毛刺线、交叉排线、天鹅绒黑与纸白. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.
...
“burr line, cross-hatching, velvet black, and paper white” sets the viewing distance. People, objects, and places can change independently.
