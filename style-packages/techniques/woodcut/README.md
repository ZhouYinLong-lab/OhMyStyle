...
![木刻版画代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **类型：** 工艺与媒介
> **目录：** `style-packages/techniques/woodcut`

## 简介

这是一个面向「木刻版画」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

刻痕、木纹、黑白块面与有限套色。Prompt 会优先表达这些可观察特征，同时保留新主题、新构图和新的对象关系。
...
“刻痕、木纹、黑白块面与有限套色”决定了这个包的观看距离。人物、物体和环境都可以另行指定。
