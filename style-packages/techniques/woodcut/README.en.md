...
![Woodcut representative image](gallery-16x9.jpg)

> **Category:** techniques
> **Type:** technique
> **Path:** `style-packages/techniques/woodcut`

## Overview

This independent style package for **Woodcut** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

刻痕、木纹、黑白块面与有限套色. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various printmakers / 跨时期技法](https://commons.wikimedia.org/w/index.php?search=woodcut+print&title=Special:MediaSearch&type=image)
...
“cut mark, wood grain, black-and-white mass, and limited spot colour” sets the viewing distance. People, objects, and places can change independently.
