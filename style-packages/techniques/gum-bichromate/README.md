...
![重铬酸盐胶印 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **类型：** 工艺或媒介
> **目录：** `style-packages/techniques/gum-bichromate`

## 简介

这是一个面向「重铬酸盐胶印」的独立风格包。它把公开作品、研究资料和可观察的媒介、构图、色彩、光线、材质与纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。
...
先把“以手工控制的树胶重铬酸盐颜料印相为基础，通过感光树胶、接触曝光、水洗和可叠加的色层，形成宽厚影调、柔和细节与明显的照片材料表面”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
