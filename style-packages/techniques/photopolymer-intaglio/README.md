...
![光聚合物凹版印刷 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/photopolymer-intaglio`
...
这项技法把摄影的连续调交给版材和压力重新解释：细节会变成网点、凹陷和擦墨关系，纸张也成为图像的一部分。它适合需要柔和灰阶与触觉表面的主题，但不会把主题限定成照片、人物或风景。
