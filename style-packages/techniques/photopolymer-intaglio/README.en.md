...
![Photopolymer Intaglio representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** printmaking
> **Path:** `style-packages/techniques/photopolymer-intaglio`

## Overview

以感光聚合物版承接影像或连续调信息，再通过凹版上墨和压印获得细密网点、柔和灰阶与纸张压痕。
...
This process lets plate and pressure reinterpret photographic continuous tone: detail becomes grain, recess, and wiped-ink relationships, while the paper becomes part of the image. It suits subjects that need soft tonal range and tactile surface without limiting them to portraits, cameras, or landscapes.
