# Aurora Gradient Grain

[中文版](README.md)

![Aurora Gradient Grain representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** design
> **Path:** `style-packages/techniques/aurora-gradient-grain`

## Overview

以极光般的连续色彩过渡、柔和噪点和有限的明度层次制造轻盈而有触感的视觉背景。
