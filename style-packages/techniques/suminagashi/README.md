...
![墨流 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/suminagashi`
...
墨流最迷人的地方，是它把控制和偶然放在同一张纸上：墨迹有方向，却不会完全听话；边界很轻，却能留下清晰的过程。它可以服务于抽象背景、纸张、包装或物件表面，不必每次都生成花朵、海浪或书法。
