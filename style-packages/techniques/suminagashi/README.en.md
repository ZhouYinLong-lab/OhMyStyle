...
![Suminagashi representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** printmaking
> **Path:** `style-packages/techniques/suminagashi`

## Overview

以水面漂浮墨迹、缓慢扰动、偶然纹理与纸张吸收之间的关系，生成轻盈而不可完全重复的表面。
...
What makes suminagashi compelling is the meeting of control and accident on one sheet: the ink has direction, but never obeys completely; the edges stay light while preserving process. It can serve an abstract field, paper, package, or object surface without forcing flowers, waves, or calligraphy into every result.
