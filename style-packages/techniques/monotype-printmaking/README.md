...
![单版画代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/monotype-printmaking`

## 简介

通过一次性版面转印、擦拭边缘、墨层不均和轻微套位变化保留绘画般的偶然性，强调不可完全复制的表面。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

单版画的魅力在于它不承诺第二次还能得到同样的结果：擦掉的地方、没有压实的边缘和纸面吸进去的墨都会留下痕迹。生成时先想象一块只上墨一次的版面，再让主体从不完整的转印里显现。与其追求“像旧版画”，不如把偶然性落实到边缘、压力和墨层上。
