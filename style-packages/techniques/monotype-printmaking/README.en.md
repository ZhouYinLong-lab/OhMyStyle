...
![Monotype Printmaking representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** printmaking
> **Path:** `style-packages/techniques/monotype-printmaking`

## Overview

One-off transfer, wiped edges, uneven ink density, and slight pressure variation
keep a painterly accident visible in the print surface.
...
The attraction is that a second pull cannot promise the same result. Wiped areas,
uncompressed edges, and ink absorbed by paper all remain visible. Imagine a plate
inked only once, then let the user's subject appear through partial transfer. Put
the accident into edges, pressure, and ink layers instead of adding a generic
“old print” filter.
