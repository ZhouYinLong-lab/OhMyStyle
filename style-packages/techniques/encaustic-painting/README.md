...
![蜡画 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 绘画
> **目录：** `style-packages/techniques/encaustic-painting`

## 简介

颜料与蜡混合、叠层、熔融和刮除；半透明蜡层、刮痕和堆积边缘构成厚薄不均的抽象表面；蜂蜜黄、乳白、烟灰、朱红和深棕形成温暖蜡质色组。
...
我会先看“颜料与蜡混合、叠层、熔融和刮除；半透明蜡层、刮痕和堆积边缘构成厚薄不均的抽象表面；蜂蜜黄、乳白、烟灰、朱红和深棕形成温暖蜡质色组”。它把观看节奏定下来，题材可以按你的需要替换。
