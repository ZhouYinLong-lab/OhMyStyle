...
![Encaustic Painting representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** painting
> **Path:** `style-packages/techniques/encaustic-painting`

## Overview

A reference-backed package for Encaustic Painting, built around layered wax, translucent pigment, and scraped tactile surface.
...
Start with “pigment and wax, translucent buildup, scraping, and an uneven tactile surface”. It sets the viewing rhythm while leaving the subject open to your prompt.
