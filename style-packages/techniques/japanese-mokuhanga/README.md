...
![日本水性木版画 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/japanese-mokuhanga`

## 简介

以分色木版、手工套印、水性颜料和纸张吸收建立清晰轮廓与细腻色层，保留手工对位的微小变化。

这是一个可独立使用的风格包。它把可观察的媒介、构图、光线、色彩、表面、纹理和复现步骤整理成可执行规则，用于生成新的主题，不用于复制某一件具体作品。

## 策展短评

这个包强调的是“分块、套印和纸张吸收”共同留下的痕迹。它可以处理人物、建筑或普通物件，不必自动滑向浮世绘题材；只要关键线、分色边界和轻微错位还在，画面就保留了木版的手工逻辑。
