...
![Japanese Water-Based Woodblock Printing representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** printmaking
> **Path:** `style-packages/techniques/japanese-mokuhanga`

## Overview

This package uses separate carved color blocks, hand registration, water-based pigment, and paper absorption to create clear contours, layered color, and small handmade shifts.
...
The package is about the traces left by block separation, registration, and paper absorption. It can handle a figure, building, or ordinary object without automatically turning it into an ukiyo-e subject; as long as the keyline, color boundaries, and slight shifts remain, the hand process stays present.
