...
![拼贴蒙太奇 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 混合媒介
> **目录：** `style-packages/techniques/photomontage`
...
拼贴蒙太奇有趣的地方，是它不急着把不同来源的片段伪装成同一个世界。手、建筑、机械或风景可以各自保留纹理与尺度，真正把它们组织起来的是剪切边缘、遮罩关系和一条清楚的视觉方向。画面因此带着纸本和暗房实验的痕迹，却不必落入怀旧滤镜。使用这个包时，先决定哪些片段承担信息，再决定哪些片段应该被删掉。
