...
![孔版印刷代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/risograph-printing`
...
孔版印刷的魅力来自“有限”：颜色被拆成几块专色，明暗交给网点，边缘留下一点套印误差，纸张也成为画面的一部分。代表图故意使用普通静物，让注意力落在版次、覆盖率和纸面触感，而不是某个固定题材。
