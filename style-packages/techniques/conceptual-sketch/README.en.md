...
![Conceptual Sketch representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** design
> **Path:** `style-packages/techniques/conceptual-sketch`

## Overview

以快速线稿、局部标记、未完成轮廓和构思痕迹记录形体方向，而不是追求完整渲染。
...
Its strongest pull comes from “quick line, partial mark, unfinished contour, and the trace of an idea still forming”. The visual order remains clear without a fixed scene.
