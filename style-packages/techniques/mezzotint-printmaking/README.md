...
![美柔汀版画 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 绘画
> **目录：** `style-packages/techniques/mezzotint-printmaking`

## 简介

铜版颗粒、刮亮高光与柔和黑阶；深色底面中浮出局部光源，画面像从黑暗里逐渐显形；深黑、银灰、暖白、暗红和棕黑形成极宽灰阶。
...
这个方向的气质落在“铜版颗粒、刮亮高光与柔和黑阶；深色底面中浮出局部光源，画面像从黑暗里逐渐显形；深黑、银灰、暖白、暗红和棕黑形成极宽灰阶”上。保住这条线索，换成新的主体也能成立。
