...
![湿版火棉胶摄影代表图](gallery-16x9.jpg)

> **分类：** 工艺与视觉技法  · **媒介领域：** 摄影工艺
> **目录：** style-packages/techniques/wet-plate-collodion
...
湿版工艺的魅力在于它不只是旧色调，而是玻璃板、化学层和手工显影共同留下的物理痕迹。这个包控制表面和处理过程，不自动加入维多利亚肖像、战争或怀旧故事。
