...
![氰版印相代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **目录：** `style-packages/techniques/cyanotype`

## 简介

这是一个面向「氰版印相」的独立风格包。它把公开资料与可观察的媒介、构图、色彩、光线、材质和纹理决策整理为可执行约束，用于生成新的主题，不用于复制某一幅具体作品。

## 风格重点

围绕普鲁士蓝色阶、接触印相轮廓、纸张不均匀感和光化学痕迹组织画面；重点是工艺结果，不把它误写成单一艺术家的个人风格。
...
先把“围绕普鲁士蓝色阶、接触印相轮廓、纸张不均匀感和光化学痕迹组织画面；重点是工艺结果，不把它误写成单一艺术家的个人风格”做准，其他内容可以留给你的 Prompt。这样换一个主题，风格仍不会散掉。
