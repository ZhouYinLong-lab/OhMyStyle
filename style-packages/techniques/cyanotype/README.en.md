...
![Cyanotype representative image](gallery-16x9.jpg)

> **Category:** techniques
> **Directory:** `style-packages/techniques/cyanotype`
...
Describes cyanotype results through Prussian-blue values, contact-print silhouettes, paper irregularity, and photochemical traces, focusing on process rather than a single artist’s personal style.

## Sources

- [维多利亚与阿尔伯特博物馆氰版印相介绍](https://www.vam.ac.uk/articles/cyanotype)
- [盖蒂保护研究所资料](https://www.getty.edu/conservation/)
...
Get “Prussian blue range, contact-print silhouettes, uneven paper, and photochemical trace” right first; leave the actual content to your prompt. The style can then travel to another subject.
