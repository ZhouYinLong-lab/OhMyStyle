...
![Filigree representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** design
> **Path:** `style-packages/techniques/filigree`

## Overview

以细密金属线条、卷草连接、镂空结构和精确重复组织装饰性表面与轻巧轮廓。
...
The character of this package sits in “fine metal line, scroll connection, openwork, and precise repetition”. Keep that thread and a new subject can still belong here.
