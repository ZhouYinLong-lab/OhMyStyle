...
![Bento Grid representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** design
> **Path:** `style-packages/techniques/bento-grid`

## Overview

以大小不一但边界清晰的模块、圆角容器、信息分组和均衡留白组织现代产品与界面布局。
...
The character of this package sits in “clear modular cells, rounded containers, grouped information, and balanced open space”. Keep that thread and a new subject can still belong here.
