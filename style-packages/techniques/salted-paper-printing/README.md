...
![盐纸印相 代表图](gallery-16x9.jpg)

> **分类：** technique
> **媒介领域：** photography
> **目录：** style-packages/techniques/salted-paper-printing

## 简介

以无涂层纸纤维、哑光表面、暖棕色调和接触印相的连续灰阶构成早期摄影纸基质感。

这是一个可独立使用的风格包。它提取可观察的视觉语言，用来处理用户指定的新主题，不会把代表图中的物体、地点、人物或故事写入默认生成结果。

## 策展短评

盐纸印相不是把照片简单染成棕色，而是让纸张本身参与成像。画面可以有失去光泽的温度，却要保留主体和灰阶，不用划痕、边框和复古道具替代工艺特征。
