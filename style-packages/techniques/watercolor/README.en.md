...
![Watercolor representative image](gallery-16x9.jpg)

> **Category:** techniques
> **Type:** technique
> **Path:** `style-packages/techniques/watercolor`

## Overview

This independent style package for **Watercolor** turns public references and observable decisions about medium, composition, color, light, material, and texture into executable constraints. It is intended for new subjects, not for reproducing a specific artwork.

## Visual focus

透明水洗、纸白、颗粒感与软硬边交替. The prompt emphasizes these observable traits while requiring a new subject, arrangement, and object relationship.

See `visual-signature.yaml`, `reproduction.yaml`, `palette/palette.json`, and `evaluation.yaml` for the complete rule set.

## Reference source

- [Various painters / 跨时期技法](https://commons.wikimedia.org/w/index.php?search=watercolor+painting+technique&title=Special:MediaSearch&type=image)
...
Get “transparent wash, paper white, granular pigment, and alternating soft and hard edges” right first; leave the actual content to your prompt. The style can then travel to another subject.
