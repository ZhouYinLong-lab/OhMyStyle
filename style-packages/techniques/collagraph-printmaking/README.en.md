...
![Collagraph Printmaking representative](gallery-16x9.jpg)

> **Category:** technique
> **Domain:** printmaking
> **Path:** `style-packages/techniques/collagraph-printmaking`

## Overview

以叠加、粘附和压印形成不均匀的版面肌理，让材料痕迹、墨色密度和纸张压痕共同构成图像。
...
Collagraph is compelling because the material does not fully submit to the image: pressure, wiping, edges, and paper absorption remain visible. It gives ordinary subjects a tactile layer while keeping the central question on how plate materials and pressure build the image, not on a mandatory newspaper or still-life motif.
