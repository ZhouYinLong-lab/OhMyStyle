...
![拼贴版画 代表图](gallery-16x9.jpg)

> **分类：** 工艺与媒介
> **媒介领域：** 版画
> **目录：** `style-packages/techniques/collagraph-printmaking`
...
拼贴版画的魅力在于材料不会完全服从图像：压痕、擦墨、边缘和纸张吸收会留下可见的过程。它让普通主题获得触觉层次，但重点仍是版面如何由材料和压力共同生成，而不是固定使用报纸或某一种物件。
